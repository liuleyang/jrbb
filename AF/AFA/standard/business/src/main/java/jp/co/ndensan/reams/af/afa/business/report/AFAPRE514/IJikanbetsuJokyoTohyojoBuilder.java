...
/**
 * {@link JikanbetsuJokyoTohyojoSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0280-031 wangm
 */
public interface IJikanbetsuJokyoTohyojoBuilder extends IReportBuilder<JikanbetsuJokyoTohyojoSource> {
