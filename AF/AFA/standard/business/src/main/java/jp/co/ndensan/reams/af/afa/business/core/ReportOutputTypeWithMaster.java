 ...
 */
public enum ReportOutputTypeWithMaster implements IReportItems {
     ...
     * 選挙資格区分
     */
    選挙資格区分(new RString("0110"), new RString(""), new RString("master.\"afT113SenkyoShikaku_shikakuKubun\"")),
    /**
     * 投票区コード
     */
     ...
     * グループコード
     */
    グループコード(new RString("0200"), new RString(""), new RString("master.\"afT112SenkyoninMeibo_groupCode\"")),
    /**
     * 住民票表示順
     */
     ...
     * 冊
     */
    冊(new RString("0220"), new RString(""), new RString("master.\"afT112SenkyoninMeibo_satsu\"")),
    /**
     * 方書
     */
     ...
     * 抹消事由コード
     */
    抹消事由コード(new RString("0290"), new RString(""), new RString("master.\"afT113SenkyoShikaku_masshoJiyuCode\"")),
    /**
     * 抹消年月日
     */
    抹消年月日(new RString("0291"), new RString(""), new RString("master.\"afT113SenkyoShikaku_masshoYMD\"")),
    /**
     * 交付番号
     */
     ...
     * 交付年月日
     */
    交付年月日(new RString("0320"), new RString(""), new RString("master.\"afT201TohyoJokyo_kofuYMD\"")),
    /**
     * 資格満了年月日
     */
     ...
     * 表示事由コード
     */
    表示事由コード(new RString("0590"), new RString(""), new RString("master.\"afT113SenkyoShikaku_hyojiJiyuCode\"")),
    /**
     * 表示年月日
     */
    表示年月日(new RString("0591"), new RString(""), new RString("master.\"afT113SenkyoShikaku_hyojiYMD\"")),
    /**
     * 識別コード
     */
    識別コード(new RString("0900"), new RString(""), new RString("master.\"afT112SenkyoninMeibo_shikibetsuCode\"")),
    /**
     * 処理日時
     */
    処理日時(new RString("0910"), new RString(""), new RString("master.\"afT112SenkyoninMeibo_insertTimestamp\"")),
    /**
     * 施設コード
     */
    施設コード(new RString("0510"), new RString(""), new RString("master.\"afT201TohyoJokyo_shisetsuCode\"")),
    /**
     * 受理年月日
     */
    受理年月日(new RString("0570"), new RString(""), new RString("master.\"afT201TohyoJokyo_juriYMD\"")),
    /**
     * 受付番号
     */
    受付番号(new RString("0530"), new RString(""), new RString("master.\"afT201TohyoJokyo_uketsukeNo\"")),
    /**
     * 名簿番号
     */
    名簿番号(new RString("0550"), new RString(""), new RString("master.\"afT112SenkyoninMeibo_groupCode\",master.\"afT112SenkyoninMeibo_tohyokuCode\","
            + "master.\"afT112SenkyoninMeibo_satsu\",master.\"afT112SenkyoninMeibo_page\",master.\"afT112SenkyoninMeibo_gyo\""));

    private final RString 項目ID;
    private final RString フォームフィールド名;
    private final RString myBatis項目名;

    private ReportOutputTypeWithMaster(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
    ...
    public static RString getMyBatis項目名(RString 項目ID) {
        ...
        for (ReportOutputTypeWithMaster type : values()) {
