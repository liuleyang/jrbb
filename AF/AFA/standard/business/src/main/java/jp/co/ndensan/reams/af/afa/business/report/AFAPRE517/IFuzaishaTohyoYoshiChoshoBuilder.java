...
/**
 * {@link FuzaishaTohyoYoshiChoshoSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0280-034 wangm
 */
public interface IFuzaishaTohyoYoshiChoshoBuilder extends IReportBuilder<FuzaishaTohyoYoshiChoshoSource> {
