 ...
 */
class KijitsumaeTohyorokuThreeMaiThirdBuilder implements IKijitsumaeTohyorokuBuilder {
     ...
     */
    public KijitsumaeTohyorokuThreeMaiThirdBuilder(IKijitsumaeTohyorokuEditor editor) {
        this.editor = editor;
    }
