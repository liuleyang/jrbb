 ...
 */
public class KijitsumaeTohyorokuThreeMaiProperty extends ReportPropertyBase<KijitsumaeTohyorokuReportSource> {

    private static final ReportId ID = new ReportId(ReportIdKeys.期日前投票録3枚タイプ.value());

    /**
     * インスタンスを生成します。
     */
    public KijitsumaeTohyorokuThreeMaiProperty() {
