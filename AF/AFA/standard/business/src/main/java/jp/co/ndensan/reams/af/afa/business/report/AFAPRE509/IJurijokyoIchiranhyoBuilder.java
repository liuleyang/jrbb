...
/**
 * {@link JurijokyoIchiranhyoSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0280-026 wangm
 */
public interface IJurijokyoIchiranhyoBuilder extends IReportBuilder<JurijokyoIchiranhyoSource> {
