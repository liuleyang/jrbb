 ...
 */
public class MasshoTsuchiHonsekiEditor implements IMasshoTsuchiHonsekiEditor {

    private static final RString 氏名 = new RString("抹消者氏名");
    private static final RString 年月日 = new RString("抹消年月日");
    ...
    private final MasshoTsuchiHonsekiParam data;

    /**
     * コンストラクタです。
     *
     * @param data {@link MasshoTsuchiHonsekiParam}
     */
    public MasshoTsuchiHonsekiEditor(MasshoTsuchiHonsekiParam data) {
        this.data = data;
    }
