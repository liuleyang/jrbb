 ...
 */
class KijitsumaeTohyorokuThreeMaiSecondBuilder implements IKijitsumaeTohyorokuBuilder {
     ...
     */
    public KijitsumaeTohyorokuThreeMaiSecondBuilder(IKijitsumaeTohyorokuEditor editor) {
        this.editor = editor;
    }
