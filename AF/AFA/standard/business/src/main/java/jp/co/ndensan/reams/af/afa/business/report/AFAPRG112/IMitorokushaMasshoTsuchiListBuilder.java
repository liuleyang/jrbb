...
/**
 * {@link MitorokushaMasshoTsuchiListSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0360-060 zhoujie3
 */
public interface IMitorokushaMasshoTsuchiListBuilder extends IReportBuilder<MitorokushaMasshoTsuchiListSource> {
