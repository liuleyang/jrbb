...
/**
 * {@link NijuTorokuChosaKaitoSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0030-034 liss
 */
public interface INijuTorokuChosaKaitoBuilder extends IReportBuilder<NijuTorokuChosaKaitoSource> {
