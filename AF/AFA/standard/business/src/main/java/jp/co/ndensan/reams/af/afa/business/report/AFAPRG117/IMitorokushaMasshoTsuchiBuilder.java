...
/**
 * {@link MitorokushaMasshoTsuchiSource} をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0360-064 b_caiyf
 */
public interface IMitorokushaMasshoTsuchiBuilder extends IReportBuilder<MitorokushaMasshoTsuchiSource> {
