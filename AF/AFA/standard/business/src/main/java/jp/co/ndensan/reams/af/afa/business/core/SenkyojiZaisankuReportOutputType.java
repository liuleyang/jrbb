...
import static jp.co.ndensan.reams.af.afa.business.core.SenkyojiZaisankuReportOutputType.values;
 ...
 */
public enum SenkyojiZaisankuReportOutputType implements IReportItems {
     ...
     * 選挙番号
     */
    選挙番号(new RString("0500"), new RString(""), new RString("\"AfT111Senkyo\".\"senkyoNo\"")),
    /**
     * 表示事由コード
     */
     ...
     * 名簿番号
     */
    名簿番号(new RString("0550"), new RString(""), new RString("\"master\".\"afT112SenkyoninMeibo_groupCode\",\"master\".\"tohyokuCode\","
            + "\"master\".\"afT112SenkyoninMeibo_satsu\",\"master\".\"page\",\"master\".\"gyo\""));

    private final RString 項目ID;
    private final RString フォームフィールド名;
    private final RString myBatis項目名;

    private SenkyojiZaisankuReportOutputType(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
    ...
    public static RString getMyBatis項目名(RString 項目ID) {
        ...
        for (SenkyojiZaisankuReportOutputType type : values()) {
