...
/**
 * {@link DairiTohyoShukeihyoSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0280-028 wangm
 */
public interface IDairiTohyoShukeihyoBuilder extends IReportBuilder<DairiTohyoShukeihyoSource> {
