 ...
 */
public class NotTorokuTsuchiRyojikanParam {
    ...
    private RString tsuchiSaki1;
    private RString tsuchiSaki2;
     ...
     */
    public NotTorokuTsuchiRyojikanParam(ZaigaiSenkyoninShinseiJohoEntity 在外選挙人申請情報, ZaigaiSakuseiChohyo 画面帳票作成入力項目) {
     ...
     * 通知先市町村名１
     *
     * @param tsuchiSaki1 RString
     */
    public void setTsuchiSaki1(RString tsuchiSaki1) {
        this.tsuchiSaki1 = tsuchiSaki1;
    }

    /**
     * 通知先市町村名2
     *
     * @param tsuchiSaki2 RString
     */
    public void setTsuchiSaki2(RString tsuchiSaki2) {
        this.tsuchiSaki2 = tsuchiSaki2;
    }
     ...
     * 通知先市町村名1
     *
     * @return tsuchiSaki1 RString
     */
    public RString getTsuchiSaki1() {
        return tsuchiSaki1;
    }
     ...
     * 通知先市町村名２
     *
     * @return tsuchiSaki2 RString
     */
    public RString getTsuchiSaki2() {
        return tsuchiSaki2;
    }
