...
/**
 * {@link JikanbetsuTohyoshaReportSource}をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0290-037 lit
 */
public interface IJikanbetsuTohyoshaBuilder extends IReportBuilder<JikanbetsuTohyoshaReportSource> {
