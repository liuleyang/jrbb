 ...
 */
class KijitsumaeTohyorokuOneMaiSecondBuilder implements IKijitsumaeTohyorokuBuilder {
     ...
     */
    public KijitsumaeTohyorokuOneMaiSecondBuilder(IKijitsumaeTohyorokuEditor editor) {
        this.editor = editor;
    }
