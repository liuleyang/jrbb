...
@Getter
@Setter
public class NijuTorokuChosaShokaiParameter {

    private final NijuTorokuChosaShokaiEntity entity;
     ...
     * コンストラクタです。
     *
     * @param entity NijuTorokuChosaShokaiEntity
     ...
     *
     */
    public NijuTorokuChosaShokaiParameter(NijuTorokuChosaShokaiEntity entity, RString 発行番号_第, RString 発行番号_番号,
            RString 発行番号_号, RString 転出先市町村名, RString 転出先郵便番号, RString allPage,
