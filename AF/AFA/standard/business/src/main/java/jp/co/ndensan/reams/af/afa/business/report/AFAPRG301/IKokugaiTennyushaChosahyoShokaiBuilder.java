...
/**
 * {@link KokugaiTennyushaChosahyoShokaiSource} をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0360-065 b_caiyf
 */
public interface IKokugaiTennyushaChosahyoShokaiBuilder extends IReportBuilder<KokugaiTennyushaChosahyoShokaiSource> {
