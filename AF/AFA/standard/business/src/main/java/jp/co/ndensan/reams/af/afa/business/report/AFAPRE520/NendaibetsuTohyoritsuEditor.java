 ...
 */
public class NendaibetsuTohyoritsuEditor implements ITohyoritsuEditor {
     ...
     */
    public NendaibetsuTohyoritsuEditor(TohyoritsuData data) {
        this.data = data;
    }
    ...
    private void set帳票共通ヘッダー(NenreibetsuTohyoritsuReportSource source) {
        ...
        source.title = new RString("年代別投票状況調べ");
    }
