 ...
 */
public class TeiseishaMeiboEditor implements ITeiseishaMeiboEditor {
    ...
    private final TeiseishaMeiboParam param;
     ...
     * コンストラクタです。
     *
     * @param param TeiseishaMeiboParam
     */
    public TeiseishaMeiboEditor(TeiseishaMeiboParam param) {
        this.param = param;
