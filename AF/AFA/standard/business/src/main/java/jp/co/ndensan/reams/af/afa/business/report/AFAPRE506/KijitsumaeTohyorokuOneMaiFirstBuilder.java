 ...
 */
class KijitsumaeTohyorokuOneMaiFirstBuilder implements IKijitsumaeTohyorokuBuilder {
     ...
     */
    public KijitsumaeTohyorokuOneMaiFirstBuilder(IKijitsumaeTohyorokuEditor editor) {
        this.editor = editor;
    }
