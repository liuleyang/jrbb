 ...
 */
public class FuzaishaTohyoshaListPorperty extends ReportPropertyBase<KijitsumaeTohyoshaListReportSource> {

    private static final ReportId ID = new ReportId(ReportIdKeys.AFAPRE502_不在者投票者一覧表.value());
     ...
     * 帳票ID
     */
    public FuzaishaTohyoshaListPorperty() {
