...
/**
 * {@link NigoShikakuChosahyoKaitoSource} をソースファイルへ出力できる形へ編集するインタフェースです。
 *
 * @reamsid_L AF-0360-062 fulc
 */
public interface INigoShikakuChosahyoKaitoBuilder extends IReportBuilder<NigoShikakuChosahyoKaitoSource> {
