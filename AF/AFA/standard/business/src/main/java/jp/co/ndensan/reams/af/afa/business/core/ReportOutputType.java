...
import static jp.co.ndensan.reams.af.afa.business.core.ReportOutputType.values;
 ...
 */
public enum ReportOutputType implements IReportItems {
     ...
     * 投票区コード
     */
    投票区コード(new RString("0120"), new RString(""), new RString("\"AfT112SenkyoninMeibo\".\"tohyokuCode\"")),
    /**
     * カナ名称
     */
    ...
    private ReportOutputType(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
    ...
    public static RString getMyBatis項目名(RString 項目ID) {
        ...
        for (ReportOutputType type : values()) {
