...
/**
 * 年齢別投票率集計表帳票プロパティクラスです。
 *
 * @reamsid_L AF-0290-036 lit
 */
public class NenreibetsuTohyoritsuProperty extends ReportPropertyBase<NenreibetsuTohyoritsuReportSource> {

    private static final ReportId ID = new ReportId(ReportIdKeys.年齢別投票率集計表.value());
     ...
     * インスタンスを生成します。
     */
    public NenreibetsuTohyoritsuProperty() {
