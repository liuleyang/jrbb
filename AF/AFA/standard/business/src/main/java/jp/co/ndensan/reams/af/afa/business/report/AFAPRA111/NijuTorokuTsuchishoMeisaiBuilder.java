 ...
 */
public class NijuTorokuTsuchishoMeisaiBuilder implements INijuTorokuTsuchishoBuilder {
     ...
     * インスタンスを生成します。
     *
     * @param meiboEditor INijuTorokuTsuchishoMeisaiEditor
     * @throws NullPointerException 引数がNullの場合
     */
    public NijuTorokuTsuchishoMeisaiBuilder(INijuTorokuTsuchishoEditor meiboEditor) {
