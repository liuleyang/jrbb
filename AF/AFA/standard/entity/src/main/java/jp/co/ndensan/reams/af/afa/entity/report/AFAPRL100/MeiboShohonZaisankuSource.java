package jp.co.ndensan.reams.af.afa.entity.report.AFAPRL100;
...
/**
 * 財産区選挙人名簿抄本ソースクラス（自動生成）です。
 *
 * @reamsid_L AF-0600-030 xul
 */
public class MeiboShohonZaisankuSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listMasshoJiyu_1", length = 10, order = 26)
...
// <editor-fold defaultstate="collapsed" desc="User Customize Area">
    ...
    @ReportItem(name = "listShikibetsuCode", order = 49)
    public RString listShikibetsuCode;
    @ReportItem(name = "listListjusho", length = 108, order = 50)
    public RString listListjusho;
    @ReportItem(name = "listShimei", length = 11, order = 51)
    public RString listShimei;
    @ReportItem(name = "shikibetsuCode", order = 52)
