 ...
 */
package jp.co.ndensan.reams.af.afa.entity.report.AFAPRG303;
 ...
 */
public class KokugaiTennyushaChosahyoKaitoSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listLastJusho1_1", length = 16, order = 12)
    public RString listLastJusho1_1;
    @ReportItem(name = "listSeinengappi_1", length = 10, order = 13)
    public RString listSeinengappi_1;
    @ReportItem(name = "listSeibetsu_1", length = 1, order = 14)
    public RString listSeibetsu_1;
    @ReportItem(name = "listTenshutsuYmd_1", length = 10, order = 15)
    public RString listTenshutsuYmd_1;
    @ReportItem(name = "listLastJusho2_1", length = 16, order = 16)
    public RString listLastJusho2_1;
    @ReportItem(name = "listShimei2_1", length = 16, order = 17)
    public RString listShimei2_1;
    @ReportItem(name = "listLastJusho3_1", length = 16, order = 18)
    public RString listLastJusho3_1;
    @ReportItem(name = "koteibunD1", length = 48, order = 19)
    public RString koteibunD1;
    @ReportItem(name = "koteibunD2", length = 48, order = 20)
...
// <editor-fold defaultstate="collapsed" desc="User Customize Area">
    ...
    @ReportItem(name = "tennyuZanTop5", order = 21) //このソースファイルの中で最後になりそうなorderを振った。ソースファイルになった時に他の項目に紛れず見やすい。
    public RString tennyuZanTop5;
    @ReportItem(name = "shimei", length = 32, order = 22)
    public RString shimei;
    @ReportItem(name = "shikibetsuCode", order = 23)
