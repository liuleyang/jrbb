...
/**
 * 投票区RelateEntityクラスです。
 *
 * @reamsid_L AF-0290-020 lit
 */
@lombok.Getter
@lombok.Setter
public class TohyokuEntity implements Cloneable, Serializable {
     ...
     * コンストラクタです。
     */
    public TohyokuEntity() {
        投票区Entity = new AfT501TohyokuEntity();
