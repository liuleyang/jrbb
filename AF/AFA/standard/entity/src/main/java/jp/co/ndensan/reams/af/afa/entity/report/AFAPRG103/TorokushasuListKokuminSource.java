 ...
 */
package jp.co.ndensan.reams.af.afa.entity.report.AFAPRG103;
...
/**
 * 投票人名簿登録者数リストのソースファイルです。
 *
 * @reamsid_L AF-0360-054 qiuxy
 */
public class TorokushasuListKokuminSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "sakuseiJoken1", length = 50, order = 19)
    public RString sakuseiJoken1;
    @ReportItem(name = "sakuseiJoken2", length = 50, order = 20)
