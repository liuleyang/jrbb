package jp.co.ndensan.reams.af.afa.entity.report.AFAPRK105;
...
/**
 * 新規登録者名簿ソースクラス（自動生成）です。
 *
 * @reamsid_L AF-0460-034 wanghj
 */
public class ShinkiTorokushaMeiboKaikuSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listMeisai2_6", length = 3, order = 28)
    public RString listMeisai2_6;
    @ReportItem(name = "listMeisai2_7", length = 3, order = 29)
...
// </editor-fold>
    @ReportItem(name = "key", length = 80, order = 31)
    public RString key;
