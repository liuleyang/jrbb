package jp.co.ndensan.reams.af.afa.entity.report.AFAPRC203;
 ...
 */
public class NankyokuSenkyoninShomeishoReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "meisaiTitle2", order = 9)
    public RString meisaiTitle2;
    @ReportItem(name = "meisaiTitle1", order = 10)
    public RString meisaiTitle1;
    @ReportItem(name = "manryoYmd", length = 11, order = 11)
    public RString manryoYmd;
    @ReportPerson(id = "X")
