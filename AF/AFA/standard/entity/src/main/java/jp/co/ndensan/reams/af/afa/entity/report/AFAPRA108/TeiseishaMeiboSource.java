package jp.co.ndensan.reams.af.afa.entity.report.AFAPRA108;
 ...
 * 訂正者名簿リストソース（自動生成）です。
 */
public class TeiseishaMeiboSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listTeiseiAfterMeisai2_6", length = 10, order = 28)
    ...
    @ReportItem(name = "listTeiseiAfterMeisai2_7", length = 10, order = 30)
    ...
    @ReportItem(name = "listTeiseiBeforeMeisai2_6", length = 10, order = 41)
    public RString listTeiseiBeforeMeisai2_6;
    @ReportItem(name = "listTeiseiBeforeMeisai2_7", length = 10, order = 42)
