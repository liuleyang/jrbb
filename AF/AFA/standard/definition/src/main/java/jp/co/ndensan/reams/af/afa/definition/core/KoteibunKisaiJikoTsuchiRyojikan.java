...
/**
 * 固定文_記載事項変更通知_領事官を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunKisaiJikoTsuchiRyojikan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunKisaiJikoTsuchiRyojikan> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_記載事項変更通知_領事官.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_記載事項変更通知_領事官
     */
    public KoteibunKisaiJikoTsuchiRyojikan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_記載事項変更通知_領事官を表す文字列
     */
    public KoteibunKisaiJikoTsuchiRyojikan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunKisaiJikoTsuchiRyojikan other = (KoteibunKisaiJikoTsuchiRyojikan) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunKisaiJikoTsuchiRyojikan o) {
