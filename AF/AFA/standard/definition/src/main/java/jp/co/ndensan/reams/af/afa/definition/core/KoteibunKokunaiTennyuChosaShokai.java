...
/**
 * 固定文_国内転入者調査票_照会を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunKokunaiTennyuChosaShokai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunKokunaiTennyuChosaShokai> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_国内転入者調査票_照会.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_国内転入者調査票_照会
     */
    public KoteibunKokunaiTennyuChosaShokai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_国内転入者調査票_照会を表す文字列
     */
    public KoteibunKokunaiTennyuChosaShokai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunKokunaiTennyuChosaShokai other = (KoteibunKokunaiTennyuChosaShokai) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunKokunaiTennyuChosaShokai o) {
