...
/**
 * 投票事由コード_国民を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class TohyoJiyuCodeKokumin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TohyoJiyuCodeKokumin> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.投票事由コード_国民.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 投票事由コード_国民
     */
    public TohyoJiyuCodeKokumin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 投票事由コード_国民を表す文字列
     */
    public TohyoJiyuCodeKokumin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TohyoJiyuCodeKokumin other = (TohyoJiyuCodeKokumin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TohyoJiyuCodeKokumin o) {
