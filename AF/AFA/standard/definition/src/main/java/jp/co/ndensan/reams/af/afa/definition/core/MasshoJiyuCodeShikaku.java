...
/**
 * 抹消事由コード_不在投票資格を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class MasshoJiyuCodeShikaku implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<MasshoJiyuCodeShikaku> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.抹消事由コード_不在投票資格.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 抹消事由コード_不在投票資格
     */
    public MasshoJiyuCodeShikaku(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 抹消事由コード_不在投票資格を表す文字列
     */
    public MasshoJiyuCodeShikaku(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final MasshoJiyuCodeShikaku other = (MasshoJiyuCodeShikaku) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(MasshoJiyuCodeShikaku o) {
