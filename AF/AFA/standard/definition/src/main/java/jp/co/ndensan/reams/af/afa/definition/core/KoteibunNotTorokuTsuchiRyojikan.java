...
/**
 * 固定文_登録を行わなかった旨の通知_領事官を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunNotTorokuTsuchiRyojikan implements ICodeValueObject, IDbColumnMappable,
        IValueObject<Code>, Comparable<KoteibunNotTorokuTsuchiRyojikan> {
    ...
    /**
     * 固定文_登録を行わなかった旨の通知_領事官を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_登録を行わなかった旨の通知_領事官.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_登録を行わなかった旨の通知_領事官
     */
    public KoteibunNotTorokuTsuchiRyojikan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_登録を行わなかった旨の通知_領事官を表す文字列
     */
    public KoteibunNotTorokuTsuchiRyojikan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunNotTorokuTsuchiRyojikan other = (KoteibunNotTorokuTsuchiRyojikan) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunNotTorokuTsuchiRyojikan o) {
