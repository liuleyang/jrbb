...
/**
 * 代理記載者入力区分を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class DairiKisaishaNyuryokuKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<DairiKisaishaNyuryokuKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.代理記載者入力区分.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 代理記載者入力区分
     */
    public DairiKisaishaNyuryokuKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 代理記載者入力区分を表す文字列
     */
    public DairiKisaishaNyuryokuKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final DairiKisaishaNyuryokuKubun other = (DairiKisaishaNyuryokuKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(DairiKisaishaNyuryokuKubun o) {
