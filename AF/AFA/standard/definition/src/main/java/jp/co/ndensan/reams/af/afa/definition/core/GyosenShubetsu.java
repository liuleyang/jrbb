 ...
 * @author n1823 有澤 礼恵
 */
public class GyosenShubetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<GyosenShubetsu> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.漁船種別.getCodeShubetsu();
    }
     ...
     * @param code 漁船種別
     */
    public GyosenShubetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 漁船種別を表す文字列
     */
    public GyosenShubetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GyosenShubetsu other = (GyosenShubetsu) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(GyosenShubetsu o) {
