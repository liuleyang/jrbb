...
/**
 * 表示事由コード_国民を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class HyojiJiyuCodeKokumin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<HyojiJiyuCodeKokumin> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.表示事由コード_国民.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 表示事由コード_国民
     */
    public HyojiJiyuCodeKokumin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 表示事由コード_国民を表す文字列
     */
    public HyojiJiyuCodeKokumin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HyojiJiyuCodeKokumin other = (HyojiJiyuCodeKokumin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(HyojiJiyuCodeKokumin o) {
