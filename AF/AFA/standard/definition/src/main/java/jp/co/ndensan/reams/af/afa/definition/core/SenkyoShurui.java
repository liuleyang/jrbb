 ...
 * @author n1823 有澤 礼恵
 */
public class SenkyoShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SenkyoShurui> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.選挙種類.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 選挙種類を表す文字列
     */
    public SenkyoShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SenkyoShurui other = (SenkyoShurui) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SenkyoShurui o) {
