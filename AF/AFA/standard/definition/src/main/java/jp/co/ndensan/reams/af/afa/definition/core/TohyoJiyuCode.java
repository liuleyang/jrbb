 ...
 * @author n1823 有澤 礼恵
 */
public class TohyoJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TohyoJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.投票事由コード.getCodeShubetsu();
    }
     ...
     * @param code 投票事由コード
     */
    public TohyoJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 投票事由コードを表す文字列
     */
    public TohyoJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TohyoJiyuCode other = (TohyoJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TohyoJiyuCode o) {
