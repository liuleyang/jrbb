...
/**
 * 登録停止事由コードを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class TorokuTeisiJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TorokuTeisiJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.登録停止事由コード.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 登録停止事由コード
     */
    public TorokuTeisiJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 登録停止事由コードを表す文字列
     */
    public TorokuTeisiJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TorokuTeisiJiyuCode other = (TorokuTeisiJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TorokuTeisiJiyuCode o) {
