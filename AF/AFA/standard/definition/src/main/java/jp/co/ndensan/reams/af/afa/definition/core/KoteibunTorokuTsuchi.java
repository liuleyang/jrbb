...
/**
 * 固定文_登録した旨の通知を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunTorokuTsuchi implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KoteibunTorokuTsuchi> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_登録した旨の通知.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_登録した旨の通知
     */
    public KoteibunTorokuTsuchi(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_登録した旨の通知を表す文字列
     */
    public KoteibunTorokuTsuchi(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunTorokuTsuchi other = (KoteibunTorokuTsuchi) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunTorokuTsuchi o) {
