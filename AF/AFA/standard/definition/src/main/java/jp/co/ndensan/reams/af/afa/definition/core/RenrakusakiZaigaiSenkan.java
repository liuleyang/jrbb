...
/**
 * 連絡先_在外帳票の選挙管理委員会を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class RenrakusakiZaigaiSenkan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<RenrakusakiZaigaiSenkan> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.連絡先_在外帳票の選挙管理委員会.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 連絡先_在外帳票の選挙管理委員会
     */
    public RenrakusakiZaigaiSenkan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 連絡先_在外帳票の選挙管理委員会を表す文字列
     */
    public RenrakusakiZaigaiSenkan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RenrakusakiZaigaiSenkan other = (RenrakusakiZaigaiSenkan) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(RenrakusakiZaigaiSenkan o) {
