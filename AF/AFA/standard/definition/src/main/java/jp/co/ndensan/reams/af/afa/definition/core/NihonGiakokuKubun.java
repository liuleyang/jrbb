...
/**
 * 日本人外国人区分を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class NihonGiakokuKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<NihonGiakokuKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.日本人外国人区分.getCodeShubetsu();
    }
     ...
     * @param code 日本人外国人区分
     */
    public NihonGiakokuKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 日本人外国人区分を表す文字列
     */
    public NihonGiakokuKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NihonGiakokuKubun other = (NihonGiakokuKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(NihonGiakokuKubun o) {
