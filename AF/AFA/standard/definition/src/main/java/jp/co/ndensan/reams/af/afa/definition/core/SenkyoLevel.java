 ...
 * @author n1823 有澤 礼恵
 */
public class SenkyoLevel implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SenkyoLevel> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.選挙レベル.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 選挙レベルを表す文字列
     */
    public SenkyoLevel(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SenkyoLevel other = (SenkyoLevel) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SenkyoLevel o) {
