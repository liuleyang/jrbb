...
/**
 * 宛名編集区分_施設宛名シールを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class AtenaHenshuSealShisetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<AtenaHenshuSealShisetsu> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.宛名編集区分_施設宛名シール.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 宛名編集区分_施設宛名シール
     */
    public AtenaHenshuSealShisetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 宛名編集区分_施設宛名シールを表す文字列
     */
    public AtenaHenshuSealShisetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final AtenaHenshuSealShisetsu other = (AtenaHenshuSealShisetsu) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(AtenaHenshuSealShisetsu o) {
