...
/**
 * 固定文_抹消通知_領事官を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunMasshoTsuchiRyojikan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunMasshoTsuchiRyojikan> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_抹消通知_領事官.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_抹消通知_領事官
     */
    public KoteibunMasshoTsuchiRyojikan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_抹消通知_領事官を表す文字列
     */
    public KoteibunMasshoTsuchiRyojikan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunMasshoTsuchiRyojikan other = (KoteibunMasshoTsuchiRyojikan) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunMasshoTsuchiRyojikan o) {
