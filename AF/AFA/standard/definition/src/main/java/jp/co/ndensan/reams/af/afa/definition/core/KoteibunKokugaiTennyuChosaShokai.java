...
/**
 * 固定文_国外転入者調査票_照会を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunKokugaiTennyuChosaShokai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunKokugaiTennyuChosaShokai> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_国外転入者調査票_照会.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_国外転入者調査票_照会
     */
    public KoteibunKokugaiTennyuChosaShokai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_国外転入者調査票_照会を表す文字列
     */
    public KoteibunKokugaiTennyuChosaShokai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunKokugaiTennyuChosaShokai other = (KoteibunKokugaiTennyuChosaShokai) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunKokugaiTennyuChosaShokai o) {
