 ...
 * @author n1823 有澤 礼恵
 */
public class KofuSoshikiCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KofuSoshikiCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.交付組織コード.getCodeShubetsu();
    }
     ...
     * @param code 交付組織コード
     */
    public KofuSoshikiCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 交付組織コードを表す文字列
     */
    public KofuSoshikiCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KofuSoshikiCode other = (KofuSoshikiCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KofuSoshikiCode o) {
