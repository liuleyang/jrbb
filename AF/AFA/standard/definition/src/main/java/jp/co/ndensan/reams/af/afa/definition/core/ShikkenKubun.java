 ...
 * @author n1823 有澤 礼恵
 */
public class ShikkenKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShikkenKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.失権区分.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 失権区分を表す文字列
     */
    public ShikkenKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShikkenKubun other = (ShikkenKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShikkenKubun o) {
