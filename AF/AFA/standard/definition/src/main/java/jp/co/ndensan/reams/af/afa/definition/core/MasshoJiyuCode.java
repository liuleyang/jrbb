 ...
 * @author n1823 有澤 礼恵
 */
public class MasshoJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<MasshoJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.抹消事由コード.getCodeShubetsu();
    }
     ...
     * @param code 抹消事由コード
     */
    public MasshoJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 抹消事由コードを表す文字列
     */
    public MasshoJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final MasshoJiyuCode other = (MasshoJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(MasshoJiyuCode o) {
