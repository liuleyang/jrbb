...
/**
 * 固定文_2号資格調査票_回答を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class Koteibun2goShikakuKaito implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<Koteibun2goShikakuKaito> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_2号資格調査票_回答.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_2号資格調査票_回答
     */
    public Koteibun2goShikakuKaito(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_2号資格調査票_回答を表す文字列
     */
    public Koteibun2goShikakuKaito(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Koteibun2goShikakuKaito other = (Koteibun2goShikakuKaito) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(Koteibun2goShikakuKaito o) {
