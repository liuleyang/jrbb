 ...
 */
package jp.co.ndensan.reams.af.afa.definition.processprm.reprintteiji;
...
@Getter
@Setter
public class AFABTA103BatchPrintProcessParameter implements IBatchProcessParameter {
     ...
     */
    public AFABTA103BatchPrintProcessParameter(ShohonNo 抄本番号, RString 抄本名, FlexibleDate 基準日, FlexibleDate 登録日,
            FlexibleDate 転出期限日, FlexibleDate 転入期限日, FlexibleDate 年齢期限日, FlexibleDate 処理日, Boolean 選挙人名簿抄本出力有無,
