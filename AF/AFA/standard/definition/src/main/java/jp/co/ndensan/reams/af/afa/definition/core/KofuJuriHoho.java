 ...
 * @author n1823 有澤 礼恵
 */
public class KofuJuriHoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KofuJuriHoho> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.交付_受理方法.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 交付_受理方法を表す文字列
     */
    public KofuJuriHoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KofuJuriHoho other = (KofuJuriHoho) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KofuJuriHoho o) {
