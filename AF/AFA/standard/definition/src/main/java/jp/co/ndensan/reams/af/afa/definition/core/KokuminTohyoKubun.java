 ...
 * @author n1823 有澤 礼恵
 */
public class KokuminTohyoKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KokuminTohyoKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.国民投票区分.getCodeShubetsu();
    }
     ...
     * @param code 国民投票区分
     */
    public KokuminTohyoKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 国民投票区分を表す文字列
     */
    public KokuminTohyoKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KokuminTohyoKubun other = (KokuminTohyoKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KokuminTohyoKubun o) {
