...
/**
 * 住所編集区分_宛名シールを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class JushoHenshuAtenaSeal implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<JushoHenshuAtenaSeal> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.住所編集区分_宛名シール.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 住所編集区分_宛名シール
     */
    public JushoHenshuAtenaSeal(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 住所編集区分_宛名シールを表す文字列
     */
    public JushoHenshuAtenaSeal(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JushoHenshuAtenaSeal other = (JushoHenshuAtenaSeal) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(JushoHenshuAtenaSeal o) {
