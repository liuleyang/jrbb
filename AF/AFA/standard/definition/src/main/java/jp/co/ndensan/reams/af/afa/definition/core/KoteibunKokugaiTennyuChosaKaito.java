...
/**
 * 固定文_国外転入者調査票_回答を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunKokugaiTennyuChosaKaito implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunKokugaiTennyuChosaKaito> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_国外転入者調査票_回答.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_国外転入者調査票_回答
     */
    public KoteibunKokugaiTennyuChosaKaito(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_国外転入者調査票_回答を表す文字列
     */
    public KoteibunKokugaiTennyuChosaKaito(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunKokugaiTennyuChosaKaito other = (KoteibunKokugaiTennyuChosaKaito) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunKokugaiTennyuChosaKaito o) {
