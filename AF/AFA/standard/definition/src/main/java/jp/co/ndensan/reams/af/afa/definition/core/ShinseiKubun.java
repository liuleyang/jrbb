 ...
 * @author n1823 有澤 礼恵
 */
public class ShinseiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShinseiKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.申請区分.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 申請区分を表す文字列
     */
    public ShinseiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShinseiKubun other = (ShinseiKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShinseiKubun o) {
