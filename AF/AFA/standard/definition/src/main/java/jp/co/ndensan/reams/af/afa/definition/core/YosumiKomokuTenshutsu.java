...
/**
 * 四隅項目_転出者用を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class YosumiKomokuTenshutsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<YosumiKomokuTenshutsu> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.四隅項目_転出者用.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 四隅項目_転出者用
     */
    public YosumiKomokuTenshutsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 四隅項目_転出者用を表す文字列
     */
    public YosumiKomokuTenshutsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YosumiKomokuTenshutsu other = (YosumiKomokuTenshutsu) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(YosumiKomokuTenshutsu o) {
