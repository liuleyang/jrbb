 ...
 * @author n1823 有澤 礼恵
 */
public class GyogyoShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<GyogyoShurui> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.漁業種類.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 漁業種類を表す文字列
     */
    public GyogyoShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GyogyoShurui other = (GyogyoShurui) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(GyogyoShurui o) {
