 ...
 * @author n1823 有澤 礼恵
 */
public class ShinsaKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShinsaKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.審査区分.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 審査区分を表す文字列
     */
    public ShinsaKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShinsaKubun other = (ShinsaKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShinsaKubun o) {
