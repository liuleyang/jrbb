...
/**
 * 裁判員審査員区分を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class SaibaninShinsainKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SaibaninShinsainKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.裁判員審査員区分.getCodeShubetsu();
    }
     ...
     * @param code 裁判員審査員区分
     */
    public SaibaninShinsainKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 裁判員審査員区分を表す文字列
     */
    public SaibaninShinsainKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SaibaninShinsainKubun other = (SaibaninShinsainKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SaibaninShinsainKubun o) {
