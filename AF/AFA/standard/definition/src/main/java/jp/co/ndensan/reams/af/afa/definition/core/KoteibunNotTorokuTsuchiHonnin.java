...
/**
 * 固定文_登録を行わなかった旨の通知_本人を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunNotTorokuTsuchiHonnin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunNotTorokuTsuchiHonnin> {
    ...
    /**
     * 固定文_登録を行わなかった旨の通知_本人を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_登録を行わなかった旨の通知_本人.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_登録を行わなかった旨の通知_本人
     */
    public KoteibunNotTorokuTsuchiHonnin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_登録を行わなかった旨の通知_本人を表す文字列
     */
    public KoteibunNotTorokuTsuchiHonnin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunNotTorokuTsuchiHonnin other = (KoteibunNotTorokuTsuchiHonnin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunNotTorokuTsuchiHonnin o) {
