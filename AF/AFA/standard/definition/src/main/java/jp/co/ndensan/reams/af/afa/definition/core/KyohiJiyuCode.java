 ...
 * @author n1823 有澤 礼恵
 */
public class KyohiJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KyohiJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.拒否事由コード.getCodeShubetsu();
    }
     ...
     * @param code 拒否事由コード
     */
    public KyohiJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 拒否事由コードを表す文字列
     */
    public KyohiJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KyohiJiyuCode other = (KyohiJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KyohiJiyuCode o) {
