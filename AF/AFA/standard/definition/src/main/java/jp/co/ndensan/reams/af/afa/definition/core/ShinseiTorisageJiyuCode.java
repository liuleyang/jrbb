...
/**
 * 申請取下事由コードを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class ShinseiTorisageJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShinseiTorisageJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.申請取下事由コード.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 申請取下事由コード
     */
    public ShinseiTorisageJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 申請取下事由コードを表す文字列
     */
    public ShinseiTorisageJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShinseiTorisageJiyuCode other = (ShinseiTorisageJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShinseiTorisageJiyuCode o) {
