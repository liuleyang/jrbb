...
/**
 * 固定文_2号資格調査票_照会を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class Koteibun2goShikakuShokai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<Koteibun2goShikakuShokai> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_2号資格調査票_照会.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_2号資格調査票_照会
     */
    public Koteibun2goShikakuShokai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_2号資格調査票_照会を表す文字列
     */
    public Koteibun2goShikakuShokai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Koteibun2goShikakuShokai other = (Koteibun2goShikakuShokai) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(Koteibun2goShikakuShokai o) {
