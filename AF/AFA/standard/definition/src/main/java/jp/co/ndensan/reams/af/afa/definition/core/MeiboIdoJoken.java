...
/**
 * 永久選挙人名簿異動条件指定を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class MeiboIdoJoken implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<MeiboIdoJoken> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.永久選挙人名簿異動条件指定.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 永久選挙人名簿異動条件指定
     */
    public MeiboIdoJoken(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 永久選挙人名簿異動条件指定を表す文字列
     */
    public MeiboIdoJoken(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final MeiboIdoJoken other = (MeiboIdoJoken) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(MeiboIdoJoken o) {
