 ...
 * @author n1823 有澤 礼恵
 */
public class SsnkyoShikakuKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SsnkyoShikakuKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.選挙資格区分.getCodeShubetsu();
    }
     ...
     * @param code 選挙資格区分
     */
    public SsnkyoShikakuKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 選挙資格区分を表す文字列
     */
    public SsnkyoShikakuKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SsnkyoShikakuKubun other = (SsnkyoShikakuKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SsnkyoShikakuKubun o) {
