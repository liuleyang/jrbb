...
/**
 * 固定文_1号登録通知を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class Koteibun1goTorokuTsuchi implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<Koteibun1goTorokuTsuchi> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_1号登録通知.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_1号登録通知
     */
    public Koteibun1goTorokuTsuchi(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_1号登録通知を表す文字列
     */
    public Koteibun1goTorokuTsuchi(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Koteibun1goTorokuTsuchi other = (Koteibun1goTorokuTsuchi) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(Koteibun1goTorokuTsuchi o) {
