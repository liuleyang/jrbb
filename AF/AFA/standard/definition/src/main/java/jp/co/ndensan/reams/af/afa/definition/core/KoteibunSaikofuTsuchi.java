...
/**
 * 固定文_再交付通知を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunSaikofuTsuchi implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KoteibunSaikofuTsuchi> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_再交付通知.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_再交付通知
     */
    public KoteibunSaikofuTsuchi(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_再交付通知を表す文字列
     */
    public KoteibunSaikofuTsuchi(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunSaikofuTsuchi other = (KoteibunSaikofuTsuchi) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunSaikofuTsuchi o) {
