...
/**
 * 抹消事由コード_国民を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class MasshoJiyuCodeKokumin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<MasshoJiyuCodeKokumin> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.抹消事由コード_国民.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 抹消事由コード_国民
     */
    public MasshoJiyuCodeKokumin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 抹消事由コード_国民を表す文字列
     */
    public MasshoJiyuCodeKokumin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final MasshoJiyuCodeKokumin other = (MasshoJiyuCodeKokumin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(MasshoJiyuCodeKokumin o) {
