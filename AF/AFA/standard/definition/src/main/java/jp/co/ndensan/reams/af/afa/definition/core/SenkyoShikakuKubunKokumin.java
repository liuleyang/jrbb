...
/**
 * 選挙資格区分_国民を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class SenkyoShikakuKubunKokumin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SenkyoShikakuKubunKokumin> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.選挙資格区分_国民.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 選挙資格区分_国民
     */
    public SenkyoShikakuKubunKokumin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 選挙資格区分_国民を表す文字列
     */
    public SenkyoShikakuKubunKokumin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SenkyoShikakuKubunKokumin other = (SenkyoShikakuKubunKokumin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SenkyoShikakuKubunKokumin o) {
