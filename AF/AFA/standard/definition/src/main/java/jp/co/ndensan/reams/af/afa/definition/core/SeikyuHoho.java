 ...
 * @author n1823 有澤 礼恵
 */
public class SeikyuHoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SeikyuHoho> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.請求方法.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 請求方法を表す文字列
     */
    public SeikyuHoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SeikyuHoho other = (SeikyuHoho) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SeikyuHoho o) {
