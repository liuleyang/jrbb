...
/**
 * 宛名編集区分_選挙人宛名シールを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class AtenaHenshuSeal implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<AtenaHenshuSeal> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.宛名編集区分_選挙人宛名シール.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 宛名編集区分_選挙人宛名シール
     */
    public AtenaHenshuSeal(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 宛名編集区分_選挙人宛名シールを表す文字列
     */
    public AtenaHenshuSeal(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final AtenaHenshuSeal other = (AtenaHenshuSeal) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(AtenaHenshuSeal o) {
