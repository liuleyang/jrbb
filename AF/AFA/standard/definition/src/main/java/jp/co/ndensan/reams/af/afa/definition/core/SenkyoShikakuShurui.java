 ...
 * @author n1823 有澤 礼恵
 */
public class SenkyoShikakuShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SenkyoShikakuShurui> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.選挙資格種類.getCodeShubetsu();
    }
     ...
     * @param code 選挙資格種類
     */
    public SenkyoShikakuShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 選挙資格種類を表す文字列
     */
    public SenkyoShikakuShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SenkyoShikakuShurui other = (SenkyoShikakuShurui) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SenkyoShikakuShurui o) {
