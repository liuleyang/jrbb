...
/**
 * 固定文_抹消通知_本籍地を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunMasshoTsuchiHonseki implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunMasshoTsuchiHonseki> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_抹消通知_本籍地.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_抹消通知_本籍地
     */
    public KoteibunMasshoTsuchiHonseki(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_抹消通知_本籍地を表す文字列
     */
    public KoteibunMasshoTsuchiHonseki(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunMasshoTsuchiHonseki other = (KoteibunMasshoTsuchiHonseki) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunMasshoTsuchiHonseki o) {
