 ...
 */
public class Keisho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<Keisho> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.敬称.getCodeShubetsu();
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Keisho other = (Keisho) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(Keisho o) {
