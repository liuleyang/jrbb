 ...
 * @author n1823 有澤 礼恵
 */
public class TenshutsuHyojiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TenshutsuHyojiKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.転出表示区分.getCodeShubetsu();
    }
     ...
     * @param code 転出表示区分
     */
    public TenshutsuHyojiKubun(Code code) {
        this.code = code;
    }
     ...
     */
    public TenshutsuHyojiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TenshutsuHyojiKubun other = (TenshutsuHyojiKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TenshutsuHyojiKubun o) {
