 ...
 * @author n1823 有澤 礼恵
 */
public class HyojiJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<HyojiJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.表示事由コード.getCodeShubetsu();
    }
     ...
     * @param code 表示事由コード
     */
    public HyojiJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 表示事由コードを表す文字列
     */
    public HyojiJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HyojiJiyuCode other = (HyojiJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(HyojiJiyuCode o) {
