...
/**
 * 固定文_国内転入者調査票_回答を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunKokunaiTennyuChosaKaito implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>,
        Comparable<KoteibunKokunaiTennyuChosaKaito> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_国内転入者調査票_回答.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_国内転入者調査票_回答
     */
    public KoteibunKokunaiTennyuChosaKaito(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_国内転入者調査票_回答を表す文字列
     */
    public KoteibunKokunaiTennyuChosaKaito(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunKokunaiTennyuChosaKaito other = (KoteibunKokunaiTennyuChosaKaito) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunKokunaiTennyuChosaKaito o) {
