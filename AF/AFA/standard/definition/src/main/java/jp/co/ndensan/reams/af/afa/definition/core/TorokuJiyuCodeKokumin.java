...
/**
 * 登録事由コード_国民を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class TorokuJiyuCodeKokumin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TorokuJiyuCodeKokumin> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.登録事由コード_国民.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 登録事由コード_国民
     */
    public TorokuJiyuCodeKokumin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 登録事由コード_国民を表す文字列
     */
    public TorokuJiyuCodeKokumin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TorokuJiyuCodeKokumin other = (TorokuJiyuCodeKokumin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TorokuJiyuCodeKokumin o) {
