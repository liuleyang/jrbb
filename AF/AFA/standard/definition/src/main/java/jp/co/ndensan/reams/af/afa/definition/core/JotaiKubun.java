 ...
 * @author n1823 有澤 礼恵
 */
public class JotaiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<JotaiKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.状態区分.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 状態区分を表す文字列
     */
    public JotaiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JotaiKubun other = (JotaiKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(JotaiKubun o) {
