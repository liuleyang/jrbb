...
/**
 * 再交付事由コードを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class SaiKofuJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<SaiKofuJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.再交付事由コード.getCodeShubetsu();
    }
     ...
     * @param code 再交付事由コード
     */
    public SaiKofuJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 再交付事由コードを表す文字列
     */
    public SaiKofuJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SaiKofuJiyuCode other = (SaiKofuJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(SaiKofuJiyuCode o) {
