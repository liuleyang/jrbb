 ...
 * @author n1823 有澤 礼恵
 */
public class TohyoShikakuShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TohyoShikakuShurui> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.投票資格種類.getCodeShubetsu();
    }
     ...
     * @param code 投票資格種類
     */
    public TohyoShikakuShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 投票資格種類を表す文字列
     */
    public TohyoShikakuShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TohyoShikakuShurui other = (TohyoShikakuShurui) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TohyoShikakuShurui o) {
