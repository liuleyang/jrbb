...
/**
 * 固定文_二重登録調査票_回答を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunNijuTorokuKaito implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KoteibunNijuTorokuKaito> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_二重登録調査票_回答.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_二重登録調査票_回答
     */
    public KoteibunNijuTorokuKaito(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_二重登録調査票_回答を表す文字列
     */
    public KoteibunNijuTorokuKaito(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunNijuTorokuKaito other = (KoteibunNijuTorokuKaito) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunNijuTorokuKaito o) {
