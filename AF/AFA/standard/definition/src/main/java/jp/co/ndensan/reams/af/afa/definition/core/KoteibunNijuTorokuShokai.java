...
/**
 * 固定文_二重登録調査票_照会を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KoteibunNijuTorokuShokai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KoteibunNijuTorokuShokai> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.固定文_二重登録調査票_照会.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 固定文_二重登録調査票_照会
     */
    public KoteibunNijuTorokuShokai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 固定文_二重登録調査票_照会を表す文字列
     */
    public KoteibunNijuTorokuShokai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KoteibunNijuTorokuShokai other = (KoteibunNijuTorokuShokai) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KoteibunNijuTorokuShokai o) {
