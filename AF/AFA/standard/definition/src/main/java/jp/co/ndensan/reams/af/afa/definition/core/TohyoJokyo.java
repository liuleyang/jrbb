 ...
 * @author n1823 有澤 礼恵
 */
public class TohyoJokyo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TohyoJokyo> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.投票状況.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 投票状況を表す文字列
     */
    public TohyoJokyo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TohyoJokyo other = (TohyoJokyo) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TohyoJokyo o) {
