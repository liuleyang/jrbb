...
/**
 * 申請内容変更事由コードを表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class ShinseiNaiyoHenkoJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShinseiNaiyoHenkoJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.申請内容変更事由コード.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 申請内容変更事由コード
     */
    public ShinseiNaiyoHenkoJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 申請内容変更事由コードを表す文字列
     */
    public ShinseiNaiyoHenkoJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShinseiNaiyoHenkoJiyuCode other = (ShinseiNaiyoHenkoJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShinseiNaiyoHenkoJiyuCode o) {
