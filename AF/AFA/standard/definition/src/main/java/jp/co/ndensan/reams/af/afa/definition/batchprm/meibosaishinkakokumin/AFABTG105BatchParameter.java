 ...
 */
package jp.co.ndensan.reams.af.afa.definition.batchprm.meibosaishinkakokumin;
...
public class AFABTG105BatchParameter extends BatchParameterBase implements IBatchProcessParameter {
    ...
    private static final String KEY_ZAICINNKAJITEHI = "最新化時点日";
    private static final String KEY_MEIBONARABIKAE = "名簿並び替え";
    ...
    @BatchParameter(key = KEY_ZAICINNKAJITEHI, name = "最新化時点日", order = 10)
    private FlexibleDate 最新化時点日;
    @BatchParameter(key = KEY_MEIBONARABIKAE, name = "名簿並び替え", order = 11)
    private Boolean 名簿並び替え;
    @BatchParameter(key = KEY_MEIBOSHOHON, name = "投票人名簿抄本出力有無", order = 12)
    private Boolean 投票人名簿抄本出力有無;
    @BatchParameter(key = KEY_TOROKUSHASULISTFLG, name = "投票人名簿登録者数リスト出力有無", order = 13)
    private Boolean 投票人名簿登録者数リスト出力有無;
    @BatchParameter(key = KEY_KUJUNBI_TOROKUSHASU, name = "時点日", order = 14)
    private FlexibleDate 時点日;
    @BatchParameter(key = KEY_FUZAISHABUNFLG, name = "不在者投票資格者分出力有無", order = 15)
    private Boolean 不在者投票資格者分出力有無;
    @BatchParameter(key = KEY_FUZAITOHYOMEIBOFLG, name = "不在資格対象者名簿出力有無", order = 16)
    private Boolean 不在資格対象者名簿出力有無;
    @BatchParameter(key = KEY_1GOSHIKAKUTSUCHIFLG, name = "一号資格登録通知出力有無", order = 17)
    private Boolean 一号資格登録通知出力有無;
    @BatchParameter(key = KEY_HAKOUBI_1GOSHIKAKU, name = "発行日_1号資格登録", order = 18)
    private FlexibleDate 発行日_1号資格登録;
    @BatchParameter(key = KEY_KAKOUNUM_DAI_1GOSHIKAKU, name = "発行番号の第_1号資格", order = 19)
    private RString 発行番号の第_1号資格;
    @BatchParameter(key = KEY_KAKOUNUM_NO_1GOSHIKAKU, name = "発行番号の番号_1号資格", order = 20)
    private RString 発行番号の番号_1号資格;
    @BatchParameter(key = KEY_KAKOUNUM_GO_1GOSHIKAKU, name = "発行番号の号_1号資格", order = 21)
    private RString 発行番号の号_1号資格;
    @BatchParameter(key = KEY_CHKSEAL1GOTSUCHIFLG, name = "送付先宛名シール出力有無_1号資格", order = 22)
    private Boolean 送付先宛名シール出力有無_1号資格;
    @BatchParameter(key = KEY_CHKSEAL1GOTSUCHIICHIRANFLG, name = "一号資格登録通知一覧表出力有無", order = 23)
    private Boolean 一号資格登録通知一覧表出力有無;
    @BatchParameter(key = KEY_2GOSHIKAKUCHOSAHYOFLG, name = "二号資格調査票出力有無", order = 24)
    private Boolean 二号資格調査票出力有無;
    @BatchParameter(key = KEY_HAKOUBI_2GOSHIKAKU, name = "発行日_2号資格", order = 25)
    private FlexibleDate 発行日_2号資格;
    @BatchParameter(key = KEY_KAKOUNUM_DAI_2GOSHIKAKU, name = "発行番号の第_2号資格", order = 26)
    private RString 発行番号の第_2号資格;
    @BatchParameter(key = KEY_KAKOUNUM_NO_2GOSHIKAKU, name = "発行番号の番号_2号資格", order = 27)
    private RString 発行番号の番号_2号資格;
    @BatchParameter(key = KEY_KAKOUNUM_GO_2GOSHIKAKU, name = "発行番号の号_2号資格", order = 28)
    private RString 発行番号の号_2号資格;
    @BatchParameter(key = KEY_CHKSEAL2GOCHOSAHYOFLG, name = "送付先宛名シール出力有無_2号資格", order = 29)
    private Boolean 送付先宛名シール出力有無_2号資格;
    @BatchParameter(key = KEY_CHK2GOCHOSAICHIRANFLG, name = "二号資格調査一覧表出力有無", order = 30)
    private Boolean 二号資格調査一覧表出力有無;
    @BatchParameter(key = KEY_2GOKOHOLISTFLG, name = "二号資格候補者一覧表出力有無", order = 31)
    private Boolean 二号資格候補者一覧表出力有無;
    @BatchParameter(key = KEY_IDOTOROKUSHAMEIBOFLG, name = "補正登録者名簿出力有無", order = 32)
    private Boolean 補正登録者名簿出力有無;
    @BatchParameter(key = KEY_CHKTOROKUSHAMEIBOJURANFLG, name = "縦覧用も作成する出力有無_補正登録者", order = 33)
    private Boolean 縦覧用も作成する出力有無;
    @BatchParameter(key = KEY_CHKSEALTOROKUSHAMEIBO, name = "補正登録者宛名シール出力有無", order = 34)
    private Boolean 補正登録者宛名シール出力有無;
    @BatchParameter(key = KEY_IDOMASSHOSHAMEIBOFLG, name = "抹消者名簿出力有無", order = 35)
    private Boolean 抹消者名簿出力有無;
    @BatchParameter(key = KEY_MASSHOBI, name = "抹消日", order = 36)
    private FlexibleDate 抹消日;
    @BatchParameter(key = KEY_CHKMASSHOSHAMEIBOJURANFLG, name = "縦覧用も作成する出力有無_抹消者", order = 37)
    private Boolean 縦覧用も作成する出力有無_抹消者;
    @BatchParameter(key = KEY_IDOTEISEISHAMEIBOFLG, name = "訂正者名簿出力有無", order = 38)
    private Boolean 訂正者名簿出力有無;
    @BatchParameter(key = KEY_MASSHOTSUCHIFLG, name = "未登録者抹消通知出力有無", order = 39)
    private Boolean 未登録者抹消通知出力有無;
    @BatchParameter(key = KEY_HAKOUBI_MASSHOTSUCHI, name = "発行日_未登録者抹消", order = 40)
    private FlexibleDate 発行日_未登録者抹消;
    @BatchParameter(key = KEY_KAKOUNUM_DAI_MASSHOTSUCHI, name = "発行番号の第_未登録者抹消", order = 41)
    private RString 発行番号の第_未登録者抹消;
    @BatchParameter(key = KEY_KAKOUNUM_NO_MASSHOTSUCHI, name = "発行番号の番号_未登録者抹消", order = 42)
    private RString 発行番号の番号_未登録者抹消;
    @BatchParameter(key = KEY_KAKOUNUM_GO_MASSHOTSUCHI, name = "発行番号の号_未登録者抹消", order = 43)
    private RString 発行番号の号_未登録者抹消;
    @BatchParameter(key = KEY_CHKSEALMASSHOTSUCHI, name = "送付先宛名シール出力有無_未登録者抹消", order = 44)
    private Boolean 送付先宛名シール出力有無_未登録者抹消;
    @BatchParameter(key = KEY_CHKMASSHOTSUCHIICHIRANFLG, name = "未登録者抹消通知一覧出力有無", order = 45)
    private Boolean 未登録者抹消通知一覧出力有無;
    @BatchParameter(key = KEY_KOKUNAICHOSAHYOFLG, name = "国内転入者調査票出力有無", order = 46)
    private Boolean 国内転入者調査票出力有無;
    @BatchParameter(key = KEY_HAKOUBI_KOKUNAICHOSA, name = "発行日_国内転入者調査票", order = 47)
    private FlexibleDate 発行日_国内転入者調査票;
    @BatchParameter(key = KEY_KAKOUNUM_DAI_KOKUNAICHOSA, name = "発行番号の第_国内転入者調査票", order = 48)
    private RString 発行番号の第_国内転入者調査票;
    @BatchParameter(key = KEY_KAKOUNUM_NO_KOKUNAICHOSA, name = "発行番号の番号_国内転入者調査票", order = 49)
    private RString 発行番号の番号_国内転入者調査票;
    @BatchParameter(key = KEY_KAKOUNUM_GO_KOKUNAICHOSA, name = "発行番号の号_国内転入者調査票", order = 50)
    private RString 発行番号の号_国内転入者調査票;
    @BatchParameter(key = KEY_CHKSEALKOKUNAICHOSAFLG, name = "送付先宛名シール出力有無_国内転入者調査票", order = 51)
    private Boolean 送付先宛名シール出力有無_国内転入者調査票;
    @BatchParameter(key = KEY_CHKKOKUNAICHOSAICHIRANFLG, name = "国内転入者調査一覧表出力有無", order = 52)
    private Boolean 国内転入者調査一覧表出力有無;
    @BatchParameter(key = KEY_KOKUGAICHOSAHYOFLG, name = "国外転入者調査票出力有無", order = 53)
    private Boolean 国外転入者調査票出力有無;
    @BatchParameter(key = KEY_HAKOUBI_KOKUGAICHOSA, name = "発行日_国外転入者調査票", order = 54)
    private FlexibleDate 発行日_国外転入者調査票;
    @BatchParameter(key = KEY_KAKOUNUM_DAI_KOKUGAICHOSA, name = "発行番号の第_国外転入者調査票", order = 55)
    private RString 発行番号の第_国外転入者調査票;
    @BatchParameter(key = KEY_KAKOUNUM_NO_KOKUGAICHOSA, name = "発行番号の番号_国外転入者調査票", order = 56)
    private RString 発行番号の番号_国外転入者調査票;
    @BatchParameter(key = KEY_KAKOUNUM_GO_KOKUGAICHOSA, name = "発行番号の号_国外転入者調査票", order = 57)
    private RString 発行番号の号_国外転入者調査票;
    @BatchParameter(key = KEY_CHKSEALKOKUGAICHOSAFLG, name = "送付先宛名シール出力有無_国外転入者調査票", order = 58)
    private Boolean 送付先宛名シール出力有無_国外転入者調査票;
    @BatchParameter(key = KEY_CHKKOKUGAICHOSAICHIRANFLG, name = "国外転入者調査一覧表出力有無", order = 59)
    private Boolean 国外転入者調査一覧表出力有無;
    @BatchParameter(key = KEY_ZAIGAISENKYONINMEIBOSHOHON, name = "在外投票人名簿抄本出力有無", order = 60)
    private Boolean 在外投票人名簿抄本出力有無;
    @BatchParameter(key = KEY_ZAIGAISHIKAKUSHAMEIBOFLG, name = "在外投票資格者名簿出力有無", order = 61)
    private Boolean 在外投票資格者名簿出力有無;
    @BatchParameter(key = KEY_ZAIGAITOHYOKANRIHYOFLG, name = "在外投票管理表出力有無", order = 62)
     ...
     */
    public AFABTG105SelectProcessParameter toAFABTG105SelectProcessParameter(IShikibetsuTaishoPSMSearchKey key) {
        return new AFABTG105SelectProcessParameter(抄本番号, 抄本名, 投票日,
                ...
                発行番号の第_国外転入者調査票, 発行番号の番号_国外転入者調査票, 発行番号の号_国外転入者調査票, key, 名簿並び替え);
    ...
    public AFABTG101SelectProcessParameter toAFABTG101SelectProcessParameter() {
        return new AFABTG101SelectProcessParameter(RString.EMPTY,
                ...
                発行番号の号_未登録者抹消, 発行日_国内転入者調査票, 発行番号の第_国内転入者調査票,
                発行番号の番号_国内転入者調査票, 発行番号の号_国内転入者調査票, 発行日_国外転入者調査票,
                発行番号の第_国外転入者調査票, 発行番号の番号_国外転入者調査票, 発行番号の号_国外転入者調査票, new ArrayList<AFABTB101Senkyoichiran>(), RString.EMPTY);
