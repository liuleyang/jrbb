 ...
 * @author n1823 有澤 礼恵
 */
public class KyakkaJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KyakkaJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.却下事由コード.getCodeShubetsu();
    }
     ...
     * @param code 却下事由コード
     */
    public KyakkaJiyuCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 却下事由コードを表す文字列
     */
    public KyakkaJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KyakkaJiyuCode other = (KyakkaJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KyakkaJiyuCode o) {
