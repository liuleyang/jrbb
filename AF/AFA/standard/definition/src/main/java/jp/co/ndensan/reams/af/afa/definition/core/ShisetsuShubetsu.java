 ...
 * @author n1823 有澤 礼恵
 */
public class ShisetsuShubetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShisetsuShubetsu> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.施設種別.getCodeShubetsu();
    }
     ...
     * @param code 施設種別
     */
    public ShisetsuShubetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 施設種別を表す文字列
     */
    public ShisetsuShubetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShisetsuShubetsu other = (ShisetsuShubetsu) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShisetsuShubetsu o) {
