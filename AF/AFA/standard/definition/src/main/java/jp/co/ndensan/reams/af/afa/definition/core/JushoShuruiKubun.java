 ...
 * @author n1823 有澤 礼恵
 */
public class JushoShuruiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<JushoShuruiKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.住所種類区分.getCodeShubetsu();
    }
     ...
     * @param code 住所種類区分
     */
    public JushoShuruiKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 住所種類区分を表す文字列
     */
    public JushoShuruiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JushoShuruiKubun other = (JushoShuruiKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(JushoShuruiKubun o) {
