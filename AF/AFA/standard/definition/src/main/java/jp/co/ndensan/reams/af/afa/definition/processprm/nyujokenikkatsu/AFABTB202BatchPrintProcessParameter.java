...
@Getter
@Setter
public class AFABTB202BatchPrintProcessParameter implements IBatchProcessParameter {
     ...
     */
    public AFABTB202BatchPrintProcessParameter(
            ShohonNo 抄本番号,
            RString 抄本名,
            RString 選挙種類,
            FlexibleDate 投票日,
