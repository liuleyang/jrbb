...
/**
 * 期日前不在者区分を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class KijitsumaeFuzaishaKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KijitsumaeFuzaishaKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.期日前不在者区分.getCodeShubetsu();
    }
     ...
     * @param code 期日前不在者区分
     */
    public KijitsumaeFuzaishaKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 期日前不在者区分を表す文字列
     */
    public KijitsumaeFuzaishaKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KijitsumaeFuzaishaKubun other = (KijitsumaeFuzaishaKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KijitsumaeFuzaishaKubun o) {
