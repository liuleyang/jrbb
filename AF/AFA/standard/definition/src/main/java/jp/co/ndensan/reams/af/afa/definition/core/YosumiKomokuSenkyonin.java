...
/**
 * 四隅項目_選挙人用を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class YosumiKomokuSenkyonin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<YosumiKomokuSenkyonin> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.四隅項目_選挙人用.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 四隅項目_選挙人用
     */
    public YosumiKomokuSenkyonin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 四隅項目_選挙人用を表す文字列
     */
    public YosumiKomokuSenkyonin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YosumiKomokuSenkyonin other = (YosumiKomokuSenkyonin) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(YosumiKomokuSenkyonin o) {
