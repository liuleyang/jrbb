...
/**
 * 四隅項目_施設用を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class YosumiKomokuShisetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<YosumiKomokuShisetsu> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.四隅項目_施設用.getCodeShubetsu();
    }
     ...
     * @param code 四隅項目_施設用
     */
    public YosumiKomokuShisetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 四隅項目_施設用を表す文字列
     */
    public YosumiKomokuShisetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YosumiKomokuShisetsu other = (YosumiKomokuShisetsu) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(YosumiKomokuShisetsu o) {
