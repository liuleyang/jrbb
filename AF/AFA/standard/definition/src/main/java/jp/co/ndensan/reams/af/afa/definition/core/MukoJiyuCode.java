 ...
 * @author n1823 有澤 礼恵
 */
public class MukoJiyuCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<MukoJiyuCode> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.無効事由コード.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 無効事由コードを表す文字列
     */
    public MukoJiyuCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final MukoJiyuCode other = (MukoJiyuCode) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(MukoJiyuCode o) {
