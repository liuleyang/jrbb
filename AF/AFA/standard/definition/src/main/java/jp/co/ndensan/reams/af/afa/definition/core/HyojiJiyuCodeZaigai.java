...
/**
 * 表示事由コード_在外を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class HyojiJiyuCodeZaigai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<HyojiJiyuCodeZaigai> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.表示事由コード_在外.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 表示事由コード_在外
     */
    public HyojiJiyuCodeZaigai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 表示事由コード_在外を表す文字列
     */
    public HyojiJiyuCodeZaigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HyojiJiyuCodeZaigai other = (HyojiJiyuCodeZaigai) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(HyojiJiyuCodeZaigai o) {
