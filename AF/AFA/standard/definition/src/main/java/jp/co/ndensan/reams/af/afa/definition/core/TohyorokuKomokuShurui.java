 ...
 * @author n1823 有澤 礼恵
 */
public class TohyorokuKomokuShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<TohyorokuKomokuShurui> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.投票録項目種類.getCodeShubetsu();
    }
     ...
     * @param code 投票録項目種類
     */
    public TohyorokuKomokuShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 投票録項目種類を表す文字列
     */
    public TohyorokuKomokuShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TohyorokuKomokuShurui other = (TohyorokuKomokuShurui) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(TohyorokuKomokuShurui o) {
