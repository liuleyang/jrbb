...
/**
 * 抹消事由コード_在外を表すドメインクラスです。
 *
 * @author n1823 有澤 礼恵
 */
public class MasshoJiyuCodeZaigai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<MasshoJiyuCodeZaigai> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.抹消事由コード_在外.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 抹消事由コード_在外
     */
    public MasshoJiyuCodeZaigai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 抹消事由コード_在外を表す文字列
     */
    public MasshoJiyuCodeZaigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final MasshoJiyuCodeZaigai other = (MasshoJiyuCodeZaigai) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(MasshoJiyuCodeZaigai o) {
