 ...
 * @author n1823 有澤 礼恵
 */
public class HonsekitiTorokuKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<HonsekitiTorokuKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.本籍地登録区分.getCodeShubetsu();
    }
     ...
     * @param code 本籍地登録区分
     */
    public HonsekitiTorokuKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 本籍地登録区分を表す文字列
     */
    public HonsekitiTorokuKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HonsekitiTorokuKubun other = (HonsekitiTorokuKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(HonsekitiTorokuKubun o) {
