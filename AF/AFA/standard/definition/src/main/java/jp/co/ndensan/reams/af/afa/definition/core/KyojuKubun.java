 ...
 * @author n1823 有澤 礼恵
 */
public class KyojuKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<KyojuKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.居住区分.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 居住区分を表す文字列
     */
    public KyojuKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KyojuKubun other = (KyojuKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(KyojuKubun o) {
