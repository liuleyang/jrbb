 ...
 * @author n1823 有澤 礼恵
 */
public class ShuseiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code>, Comparable<ShuseiKubun> {
    ...
    static {
        ...
        CODE_SHUBETSU = AFACodeShubetsu.修正区分.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 修正区分を表す文字列
     */
    public ShuseiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShuseiKubun other = (ShuseiKubun) obj;
        return Objects.equals(this.code, other.code);
    }

    @Override
    public int compareTo(ShuseiKubun o) {
