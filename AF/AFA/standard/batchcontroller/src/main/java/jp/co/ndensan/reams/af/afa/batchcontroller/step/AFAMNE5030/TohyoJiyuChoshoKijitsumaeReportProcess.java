...
import jp.co.ndensan.reams.af.afa.business.core.nippo.TohyoJiyuChoshoKijitsumaeBreakEditor;
...
/**
 * 期日前投票の事由に関する調書帳票出力のクラスです。
 *
 * @reamsid_L AF-0270-020 xul
 */
public class TohyoJiyuChoshoKijitsumaeReportProcess extends BatchKeyBreakBase<NippoPrintEntity> {

    private static final RString MAPPER_ID
            = new RString("jp.co.ndensan.reams.af.afa.persistence.db.mapper.relate.nippo."
                    + "INippoMapper.select期日前投票の事由に関する調書");
    ...
    private TohyoJiyuChoshoKijitsumaeBreakEditor editor;
    ...
    protected void beforeExecute() {
        editor = new TohyoJiyuChoshoKijitsumaeBreakEditor(parameter);
    }
    ...
    protected void createWriter() {
        ...
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdKeys.AFAPRE504_投票事由調書_期日前.value()).
