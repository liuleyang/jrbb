...
/**
 * 選挙人名簿索引簿帳票出力（50音順）のクラスです。
 *
 * @reamsid_L AF-0010-036 qiuxy
 */
public class SakuinboReport50Process extends BatchKeyBreakBase<SakuinboEntity> {
    ...
    private static final RString 改頁条件 = new RString("headKana");
    private static final RString 帳票タイトル = new RString("５０音選挙人索引簿");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(new RString(
                "jp.co.ndensan.reams.af.afa.persistence.db.mapper.teijitouroku.IAFABTA101Mapper.selectSakuinbo50List"),
                mybatisparameter);
    }

    @Override
    protected void createWriter() {
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdKeys.選挙人名簿索引簿.value(), SubGyomuCode.AFA選挙本体).
                addBreak(new BreakerCatalog<SakuinboSource>().simplePageBreaker(改頁条件)).create();
    ...
    @Override
    protected void keyBreakProcess(SakuinboEntity entity) {
    }
