...
/**
 * 国外転入者調査票宛名シール12面のバッチ処理クラスです。
 *
 * @reamsid_L AF-0360-068 b_caiyf
 */
public class KokugaiTennyushaChosahyoAtenaSeal12Process extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    private void create文字切れ一覧表に出力Writer() {
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.AFAPRE213_宛名シール国外転入者調査票.value())
                .build();
    }
