...
/**
 * 定時登録データ更新(選挙人名簿)のクラスです。
 *
 * @reamsid_L AF-0010-020 wangm
 */
public class TeijiTourokuDataUpdateSenkyoninMeiboProcess extends BatchProcessBase<TeijiTourokuDataUpdateSenkyoninMeiboEntity> {
    ...
    private static final RString 更新データ抽出 = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.teijitouroku.IAFABTA101Mapper.selectTeijiTourokuDataUpdateTrgtSenkyoninMeibo");
    ...
    protected void process(TeijiTourokuDataUpdateSenkyoninMeiboEntity entity) {
        ...
        if (識別コード != null) {
            insertSenkyoninMeiboEntity(entity, parameter.getShohonNo(), 識別コード);
        }

    }

    private void insertSenkyoninMeiboEntity(TeijiTourokuDataUpdateSenkyoninMeiboEntity entity, ShohonNo 抄本番号, ShikibetsuCode 識別コード) {
        ...
        選挙人名簿情報.setTohyokuCode(null != 選挙資格情報 ? getNullToRString(選挙資格情報.getTohyokuCode())
                : getNullToRString(entity.getTohyokuCodeAdd()));
        ...
        if (last選挙人名簿情報 == null) {
            ...
            選挙人名簿情報.setPage(1);
            選挙人名簿情報.setRenban(1);
        } else if (getNullToRString(last選挙人名簿情報.getGroupCode()).equals(getNullToRString(選挙人名簿情報.getGroupCode()))
                && getNullToRString(last選挙人名簿情報.getTohyokuCode()).equals(getNullToRString(選挙人名簿情報.getTohyokuCode()))
                && getNullToRString(last選挙人名簿情報.getSatsu()).equals(getNullToRString(選挙人名簿情報.getSatsu()))) {
