...
/**
 * 国外転入者調査一覧表のバッチ処理クラスです。
 *
 * @reamsid_L AF-0360-058 zhoujie3
 */
public class KokugaiTennyushaChosahyoListProcess extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    protected void createWriter() {
        帳票ID = ReportIdKeys.国外転入者調査一覧表.value();
        帳票タイトル = ReportIdKeys.国外転入者調査一覧表.getName();
    ...
    protected void afterExecute() {
        if (entity != null) {
            ...
            集計.append("＊国外転入者調査対象＊［男").append(DecimalFormatter.toコンマ区切りRString(男性の計, 0))
