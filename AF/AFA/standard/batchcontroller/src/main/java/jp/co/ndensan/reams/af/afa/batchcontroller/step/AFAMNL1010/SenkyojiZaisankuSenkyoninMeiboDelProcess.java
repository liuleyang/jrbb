 ...
 */
public class SenkyojiZaisankuSenkyoninMeiboDelProcess extends BatchProcessBase<AfT112SenkyoninMeiboEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.relate.senkyojizaisanku.ISenkyojiZaisankuMapper.select選挙人名簿By抄本番号");

    private AFABTL101SelectProcessParameter parameter;
    private AFABTL101SelectProcessMyBatisParameter mybatisparameter;

    @BatchWriter
    private BatchPermanentTableWriter<AfT112SenkyoninMeiboEntity> tableWriter;
    ...
    protected void createWriter() {
        tableWriter = new BatchPermanentTableWriter<>(AfT112SenkyoninMeiboEntity.class);
    }

    @Override
    protected void process(AfT112SenkyoninMeiboEntity 選挙人名簿Entity) {
        tableWriter.delete(選挙人名簿Entity);
    }
