...
/**
 * 未登録者抹消通知一覧表のバッチ処理クラスです。
 *
 * @reamsid_L AF-0360-060 zhoujie3
 */
public class MitorokushaMasshoTsuchiListProcess extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    protected void createWriter() {
        帳票ID = ReportIdKeys.未登録者抹消通知一覧表.value();
        帳票タイトル = ReportIdKeys.未登録者抹消通知一覧表.getName();
    ...
    protected void afterExecute() {
        if (entity != null) {
            ...
            集計.append("＊未登録者抹消対象者＊［男").append(DecimalFormatter.toコンマ区切りRString(男性の計, 0))
