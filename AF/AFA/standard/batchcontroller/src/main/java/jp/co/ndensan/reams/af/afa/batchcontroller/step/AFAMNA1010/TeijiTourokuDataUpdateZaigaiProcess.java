 ...
 */
public class TeijiTourokuDataUpdateZaigaiProcess extends BatchProcessBase<TeijiTourokuDataUpdateZaigaiEntity> {
    ...
    private static final RString 更新データ抽出 = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.teijitouroku.IAFABTA101Mapper.select在外選挙人名簿By抄本番号");
    ...
    protected void process(TeijiTourokuDataUpdateZaigaiEntity entity) {
        ...
        在外選挙人名簿.setShohonNo(parameter.getShohonNo());
