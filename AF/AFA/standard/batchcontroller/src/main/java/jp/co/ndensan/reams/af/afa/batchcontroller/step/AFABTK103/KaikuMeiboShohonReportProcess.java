 ...
 */
public class KaikuMeiboShohonReportProcess extends BatchKeyBreakBase<SenkyojiKaikuEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.senkyojikaiku.ISenkyojiKaikuMapper.select選挙人名簿抄本");
    ...
    protected void afterExecute() {
        ...
        pageCount.setValue(海区選挙人名簿抄本Writer.getPageCount());
    }
    ...
    private MeiboShohonJuminJouhou set住民投票資格者名簿抄本情報(SenkyojiKaikuEntity entity) {
        ...
        if (entity != null && entity.getShikibetsuTaishoEntity() != null
                && entity.getSenkyoShikakuEntity() != null && entity.getShohonEntity() != null) {
    ...
    private void create文字切れ一覧表に出力Writer() {
        CheckListLineItemSet pairs = CheckListLineItemSet.of(
                KaikuMeiboShohonReportProcess.特定項目.class,
                KaikuMeiboShohonReportProcess.チェック項目.class
        );
