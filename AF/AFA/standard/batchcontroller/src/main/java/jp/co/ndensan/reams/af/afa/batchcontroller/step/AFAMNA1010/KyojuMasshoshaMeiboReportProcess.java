 ...
 */
public class KyojuMasshoshaMeiboReportProcess extends BatchKeyBreakBase<TorokushaMeiboEntity> {
    ...
    protected void initialize() {
        ...
        builder = new ShinkiTorokushaMeiboParam.ShinkiTorokushaMeiboParamBuilder(ReportIdKeys.居住要件抹消者名簿.value());
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(new RString(
                "jp.co.ndensan.reams.af.afa.persistence.db.mapper.teijitouroku.IAFABTA101Mapper.selectKyojuMasshoshaMeiboList"),
                mybatisparameter);
    }

    @Override
    protected void createWriter() {
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdKeys.居住要件抹消者名簿.value()).create();
    ...
    private ShinkiTorokushaMeiboParam get空白行() {
        return new ShinkiTorokushaMeiboParam(getBefore(), ReportIdKeys.居住要件抹消者名簿.value(), RString.EMPTY,
