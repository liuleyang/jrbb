 ...
 * @author zhoujie3
 */
public class ShinkiTorokushaMeiboKokuminAtenaSeal21Process extends BatchProcessBase<TorokushaMeiboEntity> {
    ...
    private void create文字切れ一覧表に出力Writer() {
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.AFAPRE214_補正登録者宛名シール.value())
                .build();
    }
