 ...
 */
public class NyujokenIkkatsuNyujoken3tsuoriReportProcess extends BatchKeyBreakBase<AFABTB201MeiciJyohouSoufusakiEntity> {
    ...
    @Override
    protected void keyBreakProcess(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (is改ページ(改ページキーリスト, getBefore(), 個票3つ折情報)) {
            is改ページ = Boolean.TRUE;
        } else {
            is改ページ = Boolean.FALSE;
        }
    ...
    @Override
    protected void usualProcess(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        get入場券_印刷枚数表_印刷世帯数(個票3つ折情報);
        get入場券_印刷枚数表_人数(個票3つ折情報);
        ...
        if (is改ページ) {
            ...
            param = new Nyujoken3tsuoriParam(
                    ...
                    null, null,
                    null, null, null, null);
            param.set明細情報1(edit明細情報(個票3つ折情報));
            SoufusakiJouhou 送付先情報1 = changeEntityToSoufusakiJouhou(個票3つ折情報);
            送付先情報1.set整理番号(1);
            param.set送付先情報1(送付先情報1);
            param = editor.set送付先情報1と明細情報1_個票3つ折り(param, nyujoken3tsuori);
            get入場券_印刷枚数表_印刷枚数(個票3つ折情報);
            param.set地方公共団体情報(地方公共団体情報);
            itemCount = 1;
        } else {
            if (itemCount == 0) {
                ...
                param.set明細情報2(edit明細情報(個票3つ折情報));
                SoufusakiJouhou 送付先情報2 = changeEntityToSoufusakiJouhou(個票3つ折情報);
                送付先情報2.set整理番号(2);
                ...
                param.set明細情報3(edit明細情報(個票3つ折情報));
                SoufusakiJouhou 送付先情報3 = changeEntityToSoufusakiJouhou(個票3つ折情報);
    ...
    private SoufusakiJouhou changeEntityToSoufusakiJouhou(AFABTB201MeiciJyohouSoufusakiEntity soufusakiJouhouEntiy) {
        SoufusakiJouhou 個票3つ折情報 = new SoufusakiJouhou();
        個票3つ折情報.set世帯主名(soufusakiJouhouEntiy.get送付先世帯主名());
        個票3つ折情報.set送付先世帯コード(soufusakiJouhouEntiy.get送付先世帯コード());
        個票3つ折情報.set送付先住所(soufusakiJouhouEntiy.get送付先住所());
        個票3つ折情報.set送付先名簿_行(soufusakiJouhouEntiy.get送付先名簿_行());
        個票3つ折情報.set送付先名簿_頁(soufusakiJouhouEntiy.get送付先名簿_頁());
        個票3つ折情報.set送付先地区コード1(soufusakiJouhouEntiy.get送付先地区コード1());
        個票3つ折情報.set送付先地区名1(soufusakiJouhouEntiy.get送付先地区名1());
        個票3つ折情報.set送付先宛名(soufusakiJouhouEntiy.get送付先宛名());
        個票3つ折情報.set送付先投票区コード(soufusakiJouhouEntiy.get送付先投票区コード());
        個票3つ折情報.set送付先方書(soufusakiJouhouEntiy.get送付先方書());
        個票3つ折情報.set送付先番地(soufusakiJouhouEntiy.get送付先番地());
        個票3つ折情報.set送付先行政区コード(soufusakiJouhouEntiy.get送付先行政区コード());
        個票3つ折情報.set送付先行政区名(soufusakiJouhouEntiy.get送付先行政区名());
        個票3つ折情報.set送付先郵便番号(soufusakiJouhouEntiy.get送付先郵便番号());
        return 個票3つ折情報;
    }
    ...
    private MeisaiJouhou edit明細情報(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        MeisaiJouhou 明細情報 = new MeisaiJouhou();
        明細情報.setカナ名称(個票3つ折情報.getカナ名称());
        明細情報.set世帯コード(個票3つ折情報.get世帯コード());
        明細情報.set世帯主名(個票3つ折情報.get世帯主名());
        明細情報.set住民種別コード(個票3つ折情報.get住民種別コード());
        明細情報.set住登内住所(
                個票3つ折情報.get住所() == null ? AtenaJusho.EMPTY : new AtenaJusho(個票3つ折情報.get住所()));
        if (個票3つ折情報.get全国住所コード() == null) {
            明細情報.set住登内町域コード(個票3つ折情報.get全国住所コード().getColumnValue());
        } else {
            明細情報.set住登内町域コード(RString.EMPTY);
        }
        明細情報.set住登内番地(個票3つ折情報.get番地());
        if (個票3つ折情報.get地区コード１() == null) {
            明細情報.set地区コード1(個票3つ折情報.get地区コード１().getColumnValue());
        } else {
            明細情報.set地区コード1(RString.EMPTY);
        }
        if (個票3つ折情報.get地区コード２() == null) {
            明細情報.set地区コード2(個票3つ折情報.get地区コード２().getColumnValue());
        } else {
            明細情報.set地区コード2(RString.EMPTY);
        }
        if (個票3つ折情報.get地区コード３() == null) {
            明細情報.set地区コード3(個票3つ折情報.get地区コード３().getColumnValue());
        } else {
            明細情報.set地区コード3(RString.EMPTY);
        }
        明細情報.set地区名1(個票3つ折情報.get地区名１());
        明細情報.set地区名2(個票3つ折情報.get地区名２());
        明細情報.set地区名3(個票3つ折情報.get地区名３());
        明細情報.set性別コード(個票3つ折情報.get性別コード());
        明細情報.set投票区コード(個票3つ折情報.get投票区コード());
        明細情報.set投票区名(個票3つ折情報.get投票区名());
        明細情報.set投票所名(個票3つ折情報.get投票所名());
        if (個票3つ折情報.get投票所の住所() == null) {
            明細情報.set投票所＿住所(個票3つ折情報.get投票所の住所().getColumnValue());
        } else {
            明細情報.set投票所＿住所(RString.EMPTY);
        }
        明細情報.set続柄コード(個票3つ折情報.get続柄コード().getColumnValue());
        明細情報.set生年月日(changeFlexibleDateToRDate(個票3つ折情報.get生年月日()));

        明細情報.set投票開始時刻(個票3つ折情報.get投票開始時刻());
        明細情報.set投票終了時刻(個票3つ折情報.get投票終了時刻());
        if (個票3つ折情報.get行政区コード() == null) {
            明細情報.set行政区コード(個票3つ折情報.get行政区コード().getColumnValue());
        } else {
            明細情報.set行政区コード(RString.EMPTY);
        }
        明細情報.set行政区名(個票3つ折情報.get行政区名());
        明細情報.set名称(個票3つ折情報.get名称());
        明細情報.set頁(個票3つ折情報.get頁());
        明細情報.set行(個票3つ折情報.get行());
        明細情報.set識別コード(個票3つ折情報.get識別コード());
        明細情報.set住民票表示順(個票3つ折情報.get住民票表示順());
        return 明細情報;
    }
     ...
     * 選挙共通情報を取得する。
     *
     * @param 個票3つ折情報引数 AFABTB202SelectProcessParameter
     * @param 地方公共団体情報 Association
     * @return NyujoukenGamenModel
     */
    private NyujoukenGamenModel get選挙共通情報(AFABTB201SelectProcessParameter 個票3つ折情報引数,
            Association 地方公共団体情報) {
        NyujoukenGamenModel nyujoukenGamenModel = new NyujoukenGamenModel();
        nyujoukenGamenModel.set抄本番号(new RString(個票3つ折情報引数.get抄本番号().getColumnValue()));
        nyujoukenGamenModel.set抄本名(個票3つ折情報引数.get抄本名());
        nyujoukenGamenModel.set入場券名称1(個票3つ折情報引数.get入場券名1());
        nyujoukenGamenModel.set入場券名称2(個票3つ折情報引数.get入場券名2());
        nyujoukenGamenModel.set入場券名称3(個票3つ折情報引数.get入場券名3());
        nyujoukenGamenModel.setサンプル文字(個票3つ折情報引数.getサンプル文字());
        FlexibleDate 投票日 = 個票3つ折情報引数.get投票日();
        nyujoukenGamenModel.set投票年月日(
                投票日 == null ? null : new RDate(個票3つ折情報引数.get投票日().toString()));
        List<SenkyomeishouParam> 選挙名称リスト = new ArrayList<>();
        if (個票3つ折情報引数.get選挙リスト() != null
                && !個票3つ折情報引数.get選挙リスト().isEmpty()) {
            for (Senkyomeishou senkyomeishou : 個票3つ折情報引数.get選挙リスト()) {
    ...
    private void get入場券_印刷枚数表_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_投票区コード.isEqual(入場券印刷枚数表集計単位)) {
            get投票区コード_印刷世帯数(個票3つ折情報);

        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_住所コード.isEqual(入場券印刷枚数表集計単位)) {
            get住所コード_印刷世帯数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_行政区コード.isEqual(入場券印刷枚数表集計単位)) {
            get行政区コード_印刷世帯数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード1.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード1_印刷世帯数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード2.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード2_印刷世帯数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード3.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード3_印刷世帯数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_郵便番号.isEqual(入場券印刷枚数表集計単位)) {
            get郵便番号_印刷世帯数(個票3つ折情報);
        }
    }

    private void get投票区コード_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (RString.isNullOrEmpty(個票3つ折情報.get投票区コード())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get投票所コード())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get投票区コード()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get投票区コード(), 同一世帯コード);
        }
    }

    private void get住所コード_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get町域コード() == null
                || RString.isNullOrEmpty(個票3つ折情報.get町域コード().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get町域コード().getColumnValue())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get町域コード().getColumnValue()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get町域コード().getColumnValue(), 同一世帯コード);
        }
    }

    private void get行政区コード_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get行政区コード() == null
                || RString.isNullOrEmpty(個票3つ折情報.get行政区コード().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get行政区コード().getColumnValue())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get行政区コード().getColumnValue()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get行政区コード().getColumnValue(), 同一世帯コード);
        }
    }

    private void get地区コード1_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード１() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード１().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get地区コード１().getColumnValue())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get地区コード１().getColumnValue()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get地区コード１().getColumnValue(), 同一世帯コード);
        }
    }

    private void get地区コード2_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード２() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード２().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get地区コード２().getColumnValue())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get地区コード２().getColumnValue()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get地区コード２().getColumnValue(), 同一世帯コード);
        }
    }

    private void get地区コード3_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード３() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード３().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get地区コード３().getColumnValue())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get地区コード３().getColumnValue()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get地区コード３().getColumnValue(), 同一世帯コード);
        }
    }

    private void get郵便番号_印刷世帯数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get郵便番号() == null
                || RString.isNullOrEmpty(個票3つ折情報.get郵便番号().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷世帯数.containsKey(個票3つ折情報.get郵便番号().getColumnValue())) {
            入場券印刷枚数表_印刷世帯数.get(個票3つ折情報.get郵便番号().getColumnValue()).add(個票3つ折情報.get世帯コード());
        } else {
            Set<SetaiCode> 同一世帯コード = new HashSet<>();
            同一世帯コード.add(個票3つ折情報.get世帯コード());
            入場券印刷枚数表_印刷世帯数.put(個票3つ折情報.get郵便番号().getColumnValue(), 同一世帯コード);
        }
    }

    private void get入場券_印刷枚数表_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_投票区コード.isEqual(入場券印刷枚数表集計単位)) {
            get投票区コード_人数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_住所コード.isEqual(入場券印刷枚数表集計単位)) {
            get住所コード_人数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_行政区コード.isEqual(入場券印刷枚数表集計単位)) {
            get行政区コード_人数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード1.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード1_人数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード2.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード2_人数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード3.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード3_人数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_郵便番号.isEqual(入場券印刷枚数表集計単位)) {
            get郵便番号_人数(個票3つ折情報);
        }
    }

    private void get投票区コード_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (RString.isNullOrEmpty(個票3つ折情報.get投票区コード())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get投票所コード())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get投票区コード(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get投票区コード()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get投票区コード(), 0);
        }
    }

    private void get住所コード_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get町域コード() == null
                || RString.isNullOrEmpty(個票3つ折情報.get町域コード().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get町域コード().getColumnValue())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get町域コード().getColumnValue(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get町域コード().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get町域コード().getColumnValue(), 1);
        }
    }

    private void get行政区コード_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get行政区コード() == null
                || RString.isNullOrEmpty(個票3つ折情報.get行政区コード().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get行政区コード().getColumnValue())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get行政区コード().getColumnValue(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get行政区コード().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get行政区コード().getColumnValue(), 1);
        }
    }

    private void get地区コード1_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード１() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード１().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get地区コード１().getColumnValue())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get地区コード１().getColumnValue(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get地区コード１().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get地区コード１().getColumnValue(), 1);
        }
    }

    private void get地区コード2_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード２() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード２().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get地区コード２().getColumnValue())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get地区コード２().getColumnValue(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get地区コード２().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get地区コード２().getColumnValue(), 1);
        }
    }

    private void get地区コード3_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード３() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード３().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get地区コード３().getColumnValue())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get地区コード３().getColumnValue(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get地区コード３().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get地区コード３().getColumnValue(), 1);
        }
    }

    private void get郵便番号_人数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get郵便番号() == null
                || RString.isNullOrEmpty(個票3つ折情報.get郵便番号().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_人数リスト.containsKey(個票3つ折情報.get郵便番号().getColumnValue())) {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get郵便番号().getColumnValue(),
                    入場券印刷枚数表_人数リスト.get(個票3つ折情報.get郵便番号().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_人数リスト.put(個票3つ折情報.get郵便番号().getColumnValue(), 1);
        }
    }

    private void get入場券_印刷枚数表_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_投票区コード.isEqual(入場券印刷枚数表集計単位)) {
            get投票区コード_印刷枚数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_住所コード.isEqual(入場券印刷枚数表集計単位)) {
            get住所コード_印刷枚数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_行政区コード.isEqual(入場券印刷枚数表集計単位)) {
            get行政区コード_印刷枚数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード1.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード1_印刷枚数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード2.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード2_印刷枚数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_地区コード3.isEqual(入場券印刷枚数表集計単位)) {
            get地区コード3_印刷枚数(個票3つ折情報);
        } else if (AFAConfigKeysValue.入場券_印刷枚数表_集計単位_郵便番号.isEqual(入場券印刷枚数表集計単位)) {
            get郵便番号_印刷枚数(個票3つ折情報);
        }
    }

    private void get投票区コード_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (RString.isNullOrEmpty(個票3つ折情報.get投票区コード())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get投票所コード())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get投票区コード(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get投票区コード()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get投票区コード(), 1);
        }
    }

    private void get住所コード_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get町域コード() == null
                || RString.isNullOrEmpty(個票3つ折情報.get町域コード().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get町域コード().getColumnValue())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get町域コード().getColumnValue(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get町域コード().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get町域コード().getColumnValue(), 1);
        }
    }

    private void get行政区コード_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get行政区コード() == null
                || RString.isNullOrEmpty(個票3つ折情報.get行政区コード().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get行政区コード().getColumnValue())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get行政区コード().getColumnValue(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get行政区コード().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get行政区コード().getColumnValue(), 1);
        }
    }

    private void get地区コード1_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード１() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード１().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get地区コード１().getColumnValue())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get地区コード１().getColumnValue(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get地区コード１().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get地区コード１().getColumnValue(), 1);
        }
    }

    private void get地区コード2_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード２() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード２().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get地区コード２().getColumnValue())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get地区コード２().getColumnValue(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get地区コード２().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get地区コード２().getColumnValue(), 1);
        }
    }

    private void get地区コード3_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get地区コード３() == null
                || RString.isNullOrEmpty(個票3つ折情報.get地区コード３().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get地区コード３().getColumnValue())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get地区コード３().getColumnValue(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get地区コード３().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get地区コード３().getColumnValue(), 1);
        }
    }

    private void get郵便番号_印刷枚数(AFABTB201MeiciJyohouSoufusakiEntity 個票3つ折情報) {
        if (個票3つ折情報.get郵便番号() == null
                || RString.isNullOrEmpty(個票3つ折情報.get郵便番号().getColumnValue())) {
            return;
        }
        if (入場券印刷枚数表_印刷枚数リスト.containsKey(個票3つ折情報.get郵便番号().getColumnValue())) {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get郵便番号().getColumnValue(),
                    入場券印刷枚数表_印刷枚数リスト.get(個票3つ折情報.get郵便番号().getColumnValue()) + 1);
        } else {
            入場券印刷枚数表_印刷枚数リスト.put(個票3つ折情報.get郵便番号().getColumnValue(), 1);
        }
    }
