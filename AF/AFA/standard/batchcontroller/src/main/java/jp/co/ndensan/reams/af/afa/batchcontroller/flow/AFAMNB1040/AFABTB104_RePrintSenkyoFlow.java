 ...
 */
package jp.co.ndensan.reams.af.afa.batchcontroller.flow.AFAMNB1040;
...
/**
 * 選挙時登録帳票再発行のバッチ処理クラスです。
 *
 * @reamsid_L AF-0060-020 liss
 */
public class AFABTB104_RePrintSenkyoFlow extends BatchFlowBase<AFABTB104BatchParameter> {
    ...
    IBatchFlowCommand get不在資格対象者名簿帳票出力() {
        return loopBatch(FuzaiShikakushaMeiboReportprocess.class).arguments(selectProcessParameter).define();
    }
