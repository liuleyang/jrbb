 ...
 * @author zhoujie3
 */
public class MitorokushaMasshoTsuchiAtenaSeal21Process extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    private void create文字切れ一覧表に出力Writer() {
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.AFAPRE214_宛名シール未登録者抹消通知.value())
                .build();
    }
