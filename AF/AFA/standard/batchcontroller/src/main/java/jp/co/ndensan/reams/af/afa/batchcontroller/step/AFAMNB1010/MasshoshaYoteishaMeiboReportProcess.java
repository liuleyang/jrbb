 ...
 */
public class MasshoshaYoteishaMeiboReportProcess extends BatchKeyBreakBase<TorokushaMeiboEntity> {
    ...
    protected void initialize() {
        ...
        builder = new ShinkiTorokushaMeiboParam.ShinkiTorokushaMeiboParamBuilder(ReportIdKeys.抹消予定者名簿.value());
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(new RString(
                "jp.co.ndensan.reams.af.afa.persistence.db.mapper.senkyojitouroku.IAFABTB101Mapper.selectMasshoYoteishaMeiboList"),
                mybatisparameter);
    }

    @Override
    protected void createWriter() {
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdKeys.抹消予定者名簿.value()).create();
    ...
    private ShinkiTorokushaMeiboParam get空白行() {
        return new ShinkiTorokushaMeiboParam(getBefore(), ReportIdKeys.抹消予定者名簿.value(), RString.EMPTY,
