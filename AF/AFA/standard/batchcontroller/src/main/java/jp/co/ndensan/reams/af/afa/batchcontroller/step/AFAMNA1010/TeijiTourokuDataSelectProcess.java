 ...
 *
 */
public class TeijiTourokuDataSelectProcess extends BatchProcessBase<TeijiTourokuListEntity> {
    ...
    private static final RString 宛名PSMデータ取得
            = new RString("jp.co.ndensan.reams.af.afa.persistence.db.mapper.teijitouroku.IAFABTA101Mapper.selectTeijiTourokuList");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(宛名PSMデータ取得, mybatisparameter);
    }
    ...
    private boolean is有権者(SenkyoninTohyoJokyoEntity senkyoEntity) {
        return shikakuhantei.is有権者(senkyoEntity.getAtenaPSMEntity(),
                ...
                SenkyoShurui.定時登録, senkyoEntity.getSenkyoShikakuEntity());
    }
