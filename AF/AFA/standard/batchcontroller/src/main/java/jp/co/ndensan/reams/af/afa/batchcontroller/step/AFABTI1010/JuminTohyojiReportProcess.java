 ...
 */
public class JuminTohyojiReportProcess extends BatchKeyBreakBase<JuminTohyojiEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.jumintohyoji.IJuminTohyojiMapper.select住民投票資格者名簿抄本データ");
    ...
    @BatchWriter
    private IBatchReportWriterWithCheckList<MeiboShohonJuminSource> 住民投票資格者名簿抄本Writer;
    private ReportSourceWriter<MeiboShohonJuminSource> 住民投票資格者名簿抄本SourceWriter;
    ...
    protected void createWriter() {
        ...
        住民投票資格者名簿抄本SourceWriter = new ReportSourceWriter<>(住民投票資格者名簿抄本Writer);
    }
    ...
    protected void keyBreakProcess(JuminTohyojiEntity entity) {
        ...
        MeiboShohonJuminParam param = new MeiboShohonJuminParam(住民投票資格者名簿抄本情報, 住民投票資格者名簿抄本情報集計,
                getBefore().getUaFt200Entity(), getBefore().getAfT113Entity(), get地方公共団体(getBefore()));

        MeiboShohonJuminReport report = new MeiboShohonJuminReport(param);
        report.writeBy(住民投票資格者名簿抄本SourceWriter);
    }
    ...
    protected void afterExecute() {
        ...
        住民投票資格者名簿抄本情報_new.set帳票タイトル(ReportIdKeys.AFAPRI100_住民投票時登録.getReportName());
        住民投票資格者名簿抄本情報_new.setTotalPage((new RString(String.valueOf(totalPage))));

        MeiboShohonJuminParam param = new MeiboShohonJuminParam(住民投票資格者名簿抄本情報_new, 住民投票資格者名簿抄本情報集計,
                宛名識別対象_new, 選挙資格_new, 地方公共団体情報_new);
        MeiboShohonJuminReport report = new MeiboShohonJuminReport(param);
        report.writeBy(住民投票資格者名簿抄本SourceWriter);

        pageCount.setValue(住民投票資格者名簿抄本Writer.getPageCount());
    }
    ...
    private void create文字切れ一覧表に出力Writer() {
        CheckListLineItemSet pairs = CheckListLineItemSet.of(
                JuminTohyojiReportProcess.特定項目.class,
                JuminTohyojiReportProcess.チェック項目.class
        );
