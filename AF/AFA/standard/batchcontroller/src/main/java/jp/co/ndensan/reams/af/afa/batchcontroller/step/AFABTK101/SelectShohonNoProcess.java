 ...
 */
public class SelectShohonNoProcess extends BatchProcessBase<AfT100ShohonEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.meibosakuseikaiku.IMeiboSakuseiKaikuMapper.select抄本番号");
