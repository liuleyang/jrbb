...
/**
 * 国外転入者調査票（照会）のバッチ処理クラスです。
 *
 * @reamsid_L AF-0360-065 b_caiyf
 */
public class KokugaiTennyushaChosahyoShokaiProcess extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    protected void initialize() {
        ...
        帳票ID = ReportIdKeys.国外転入者調査票照会.value();
    ...
    private void create文字切れ一覧表に出力Writer() {
        CheckListLineItemSet pairs = CheckListLineItemSet.of(
                KokugaiTennyushaChosahyoShokaiProcess.特定項目.class,
                KokugaiTennyushaChosahyoShokaiProcess.チェック項目.class);
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.国外転入者調査票照会.value())
