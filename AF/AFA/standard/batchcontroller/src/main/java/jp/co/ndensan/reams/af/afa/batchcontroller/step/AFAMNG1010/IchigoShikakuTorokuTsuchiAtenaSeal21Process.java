 ...
 * @author zhoujie3
 */
public class IchigoShikakuTorokuTsuchiAtenaSeal21Process extends BatchProcessBase<IchigoShikakuTorokuTsuchiListEntity> {
    ...
    private void create文字切れ一覧表に出力Writer() {
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.AFAPRE214_宛名シール1号資格登録通知.value())
                .build();
    }
