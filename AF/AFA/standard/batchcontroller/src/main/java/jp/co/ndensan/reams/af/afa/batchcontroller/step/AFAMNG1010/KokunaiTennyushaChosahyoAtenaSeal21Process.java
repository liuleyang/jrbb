 ...
 * @author zhoujie3
 */
public class KokunaiTennyushaChosahyoAtenaSeal21Process extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    private void create文字切れ一覧表に出力Writer() {
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.AFAPRE214_宛名シール国内転入者調査票.value())
                .build();
    }
