 ...
 */
public class SenkyoDelProcess extends BatchProcessBase<AfT111SenkyoEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.senkyojikaiku.ISenkyojiKaikuMapper.select選挙By抄本番号");
