...
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB100.NijuTorokuChosaShokaiLayoutBreak;
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB100.NijuTorokuChosaShokaiListReport;
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB100.NijuTorokuChosaShokaiPageBreak;
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB100.NijuTorokuChosaShokaiParameter;
 ...
 */
public class NijuTorokuChosaShokaiReportProcess extends BatchKeyBreakBase<NijuTorokuChosaShokaiEntity> {
    ...
    @BatchWriter
    private IBatchReportWriterWithCheckList<NijuTorokuChosaShokaiSource> batchReportWriter;
    private ReportSourceWriter<NijuTorokuChosaShokaiSource> reportSourceWriter;
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(new RString(
                "jp.co.ndensan.reams.af.afa.persistence.db.mapper.senkyojitouroku.IAFABTB101Mapper.selectNijuTorokuChosaShokai"),
                mybatisparameter);
    }
    ...
    @Override
    protected void keyBreakProcess(NijuTorokuChosaShokaiEntity current) {
    ...
    private boolean hasBreak(NijuTorokuChosaShokaiEntity before, NijuTorokuChosaShokaiEntity current) {
    ...
    @Override
    protected void usualProcess(NijuTorokuChosaShokaiEntity entity) {
        if (page == 1) {
        ...
        NijuTorokuChosaShokaiParameter param = new NijuTorokuChosaShokaiParameter(entity, 発行番号_第, 発行番号_番号, 発行番号_号,
                転出先市町村名, 転出先郵便番号, new RString(String.valueOf(allPage)), 地方公共団体, 転出期間_開始日, 転出期間_終了日,
                new RString(String.valueOf(page)), layoutIndex);
        NijuTorokuChosaShokaiListReport report = new NijuTorokuChosaShokaiListReport(param);
    ...
    private SenkyoninTohyoJokyoEntity toSenkyoninTohyoJokyoEntity(NijuTorokuChosaShokaiEntity entity) {
    ...
    private void set共通項目(NijuTorokuChosaShokaiEntity entity) {
    ...
    private void create文字切れ一覧表に出力Writer() {
        CheckListLineItemSet pairs = CheckListLineItemSet.of(
                NijuTorokuChosaShokaiReportProcess.特定項目.class,
                NijuTorokuChosaShokaiReportProcess.チェック項目.class);
        ...
        batchReportWriter = BatchWriters
                .batchReportWriterWithCheckList(NijuTorokuChosaShokaiSource.class)
                .checkListInfo(info)
                .checkListLineItemSet(pairs)
                .reportId(ReportIdKeys.二重登録調査票_照会.value())
                .addBreak(new NijuTorokuChosaShokaiLayoutBreak())
                .addBreak(new NijuTorokuChosaShokaiPageBreak())
                .build();
    }
