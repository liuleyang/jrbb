 ...
 */
public class InsertShikibetsuCodeNoProcess extends BatchProcessBase<MeiboTempTableEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.af.afa.persistence.db.mapper.meibosakuseikaiku.IMeiboSakuseiKaikuMapper.select識別コードない");
