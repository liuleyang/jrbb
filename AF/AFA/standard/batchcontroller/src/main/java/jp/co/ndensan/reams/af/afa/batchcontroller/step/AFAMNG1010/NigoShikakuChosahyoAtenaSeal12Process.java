 ...
 * @author zhoujie3
 */
public class NigoShikakuChosahyoAtenaSeal12Process extends BatchProcessBase<MitorokushaMasshoTsuchiListEntity> {
    ...
    private void create文字切れ一覧表に出力Writer() {
        ...
        btchReportWriter = BatchWriters
                ...
                .reportId(ReportIdKeys.AFAPRE213_宛名シール2号資格調査票.value())
                .build();
    }
