...
import jp.co.ndensan.reams.af.afa.entity.db.basic.helper.AfT147Chiku3ConditionEntityGenerator;
...
/**
 * {@link AfT147Chiku3ConditionDac}のテストクラスです。
 *
 * @author N1823 有澤 礼恵
 */
@RunWith(Enclosed.class)
public class AfT147Chiku3ConditionDacTest extends AfaTestDacBase {

    private static AfT147Chiku3ConditionDac sut;
    ...
    public static void setUpClass() {
        sut = InstanceProvider.create(AfT147Chiku3ConditionDac.class);
    ...
    public static class selectTest_ShohonNo extends AfaTestDacBase {
        ...
        public void setUp() {
            ...
            sut.insert(create地区3条件(抄本9991));
            sut.insert(create地区3条件(抄本9992));
        }

        @Test
        public void 抄本番号9991を指定した場合_抄本番号_999991のエンティティを返す() {
            AfT147Chiku3ConditionEntity result = sut.select(抄本9991);
            assertThat(result.getChikuCode3(), is(new ChikuCode("999991")));
        }

        @Test
        public void 未登録の抄本番号を指定した場合_nullが返る() {
            AfT147Chiku3ConditionEntity result = sut.select(new ShohonNo(999999));
            assertNull(result);
        }
    }
    ...
    public static class selectTest_All extends AfaTestDacBase {
        ...
        public void 引数なしで検索した場合_2件返る() {
            List<AfT147Chiku3ConditionEntity> result = sut.select();
    ...
    public static class insertTest extends AfaTestDacBase {
        ...
        public void 抄本番号9992のentityを指定した場合_insertが実行される() {
            ...
            AfT147Chiku3ConditionEntity result = sut.select(抄本9992);
    ...
    public static class insertTest_List extends AfaTestDacBase {
        ...
        public void 抄本番号9991と抄本番号9992の複数件数Listを指定した場合_処理件数2件が返る() {
            List<AfT147Chiku3ConditionEntity> entities = new ArrayList<>();
            entities.add(create地区3条件(抄本9991));
            entities.add(create地区3条件(抄本9992));
    ...
    public static class deleteTest extends AfaTestDacBase {
        ...
        public void 抄本番号9991のentityを指定した場合_deleteが成功し_1が返る() {
            AfT147Chiku3ConditionEntity entity = sut.select(抄本9991);
    ...
    public static class deleteTest_List extends AfaTestDacBase {
        ...
        public void 引数を指定しなかった場合_deleteが成功し_処理件数2件が返る() {
            List<AfT147Chiku3ConditionEntity> entities = sut.select();
    ...
    private static AfT147Chiku3ConditionEntity create地区3条件(ShohonNo shohonNo) {
        return AfT147Chiku3ConditionEntityGenerator.createAfT147Chiku3ConditionEntity(shohonNo);
    }
    ...
    private static void deleteTable(AfT147Chiku3ConditionDac dac) {
        List<AfT147Chiku3ConditionEntity> list = dac.select();
        dac.delete(list);
    }
