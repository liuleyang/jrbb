 ...
 */
public enum ZaigaiMeiboTorokuSpec implements IPredicate<ZaigaiMeiboTorokuDiv> {
    ...
    在住情報の住定日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在住情報の住定日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiZaijuJoho().getTxtJuteiYMD();
    ...
    在住情報の住定日関連のチェック_転出日以降 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在住情報_住定日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiZaijuJoho().getTxtJuteiYMD();
                    if (在住情報_住定日.isDisabled() || 在住情報_住定日.isReadOnly() || !在住情報_住定日.isVisible()) {
                        return true;
                    }
                    RDate 住定日 = 在住情報_住定日.getValue();
                    TextBoxDate 在住情報の住定日関連のチェック = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiHonninJoho().getTxtTenshutsuYMD();
    ...
    本人情報の最終住所エリアの転出日関連のチェック {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 本人情報の最終住所エリアの転出日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiHonninJoho().getTxtTenshutsuYMD();
    ...
    申請情報の申請日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 申請情報の申請日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtShinseiYMD();
    ...
    申請情報の申請日関連のチェック_住定日以降 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 申請情報_申請日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtShinseiYMD();
                    if (申請情報_申請日.isDisabled() || 申請情報_申請日.isReadOnly() || !申請情報_申請日.isVisible()) {
                        return true;
                    }
                    RDate 申請日 = 申請情報_申請日.getValue();
                    TextBoxDate 申請情報の申請日関連のチェック_住定日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiZaijuJoho().getTxtJuteiYMD();
    ...
    申請情報の申請取下げ日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 申請情報の申請取下げ日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtTorisageYMD();
    ...
    申請情報の申請取下げ日関連のチェック_申請日以降 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    ...
                    RDate 申請取下げ日 = 申請情報の申請取下げ日.getValue();
                    TextBoxDate 申請情報の申請取下げ日関連のチェック_申請日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtShinseiYMD();
    ...
    在外選挙人名簿情報の登録日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報の登録日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtTorokuYMD();
    ...
    在外選挙人名簿情報の登録日関連のチェック_申請日以降 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報_登録日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtTorokuYMD();
                    if (在外選挙人名簿情報_登録日.isDisabled() || 在外選挙人名簿情報_登録日.isReadOnly() || !在外選挙人名簿情報_登録日.isVisible()) {
                        return true;
                    }
                    RDate 登録日 = 在外選挙人名簿情報_登録日.getValue();
                    TextBoxDate 在外選挙人名簿情報の登録日関連のチェック_申請日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtShinseiYMD();
    ...
    在外選挙人名簿情報の登録日関連のチェック_規定年齢到達日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 名簿情報の登録日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtTorokuYMD();
                    if (名簿情報の登録日.isDisabled() || 名簿情報の登録日.isReadOnly() || !名簿情報の登録日.isVisible()) {
                        return true;
                    }
                    RDate 登録日 = 名簿情報の登録日.getValue();
                    TextBoxFlexibleDate 在外選挙人名簿情報の登録日関連のチェック_生年月日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiHonninJoho().getTxtSeinengappiYMD();
                    ...
                    return !登録日.isBefore(new RDate(生年月日.plusYear(選挙資格到達年齢).toString()));
                }
            },
    /**
     * 在外選挙人名簿情報の登録日関連のチェックをチェックします。
    ...
    在外選挙人名簿情報の登録日関連のチェック_転入3か月経過 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    ...
                    TextBoxDate 在外選挙人名簿情報の登録日関連のチェック_住定日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiZaijuJoho().getTxtJuteiYMD();
                    RDate 住定日 = 在外選挙人名簿情報の登録日関連のチェック_住定日.getValue();
                    if (null == 登録日 || null == 住定日) {
                        return true;
                    }
                    return !登録日.isBefore(住定日.plusMonth(1 + 1 + 1));
                }
            },
    /**
    ...
    申請情報の選挙人証交付日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 申請情報の選挙人証交付日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtKofuYMD();
    ...
    申請情報の選挙人証交付日関連のチェック_登録日以降 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 申請情報_選挙人証交付日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtKofuYMD();
                    if (申請情報_選挙人証交付日.isDisabled() || 申請情報_選挙人証交付日.isReadOnly() || !申請情報_選挙人証交付日.isVisible()) {
                        return true;
                    }
                    RDate 選挙人証交付日 = 申請情報_選挙人証交付日.getValue();
                    TextBoxDate 申請情報の選挙人証交付日関連のチェック_登録日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtTorokuYMD();
    ...
    申請情報の選挙人証交付日関連のチェック_交付履歴 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 選挙人証交付日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtKofuYMD();
                    ...
                    ShikibetsuCode 識別コード = div.getCcdZaigaiMeiboKojinJoho().getCcdKojinJohoUR().getAtenaShokaiSimpleData()
    ...
    在外選挙人名簿情報の表示日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報の表示日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtHyojiYMD();
    ...
    在外選挙人名簿情報の表示日関連のチェック_登録日以降 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    ...
                    RDate 表示日 = 在外選挙人名簿情報の表示日.getValue();
                    TextBoxDate 在外選挙人名簿情報の表示日関連のチェック_登録日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtTorokuYMD();
    ...
    在外選挙人名簿情報の国内転入日関連のチェック_表示事由 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報の国内転入日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtKokunaiTennyuYMD();
                    if (在外選挙人名簿情報の国内転入日.isDisabled() || 在外選挙人名簿情報の国内転入日.isReadOnly()
                    || !在外選挙人名簿情報の国内転入日.isVisible()) {
                        return true;
                    }
                    RDate 国内転入日 = 在外選挙人名簿情報の国内転入日.getValue();
                    IJiyuNameListDiv 表示事由 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getCcdHyojiJiyu();
    ...
    在外選挙人名簿情報の国内転入日関連のチェック_抹消事由 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報_国内転入日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtKokunaiTennyuYMD();
                    if (在外選挙人名簿情報_国内転入日.isDisabled() || 在外選挙人名簿情報_国内転入日.isReadOnly()
                    || !在外選挙人名簿情報_国内転入日.isVisible()) {
                        return true;
                    }
                    RDate 国内転入日 = 在外選挙人名簿情報_国内転入日.getValue();
                    IJiyuNameListDiv 抹消事由 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getCcdMasshoJiyu();
    ...
    在外選挙人名簿情報の修正日関連のチェック_未来日 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報の修正日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtShuseiYMD();
    ...
    在外選挙人名簿情報の修正日関連のチェック_登録日以降 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 在外選挙人名簿情報_修正日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtShuseiYMD();
                    if (在外選挙人名簿情報_修正日.isDisabled() || 在外選挙人名簿情報_修正日.isReadOnly()
                    || !在外選挙人名簿情報_修正日.isVisible()) {
                        return true;
                    }
                    RDate 修正日 = 在外選挙人名簿情報_修正日.getValue();
                    TextBoxDate 在外選挙人名簿情報の修正日関連のチェック_登録日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtTorokuYMD();
    ...
    申請取下げ日取下げ事由のチェック_申請取下げ日未入力 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 申請取下げ日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtTorisageYMD();
                    IJiyuNameListDiv 取下げ事由 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getCcdTorisageJiyu();
    ...
    申請取下げ日取下げ事由のチェック_取下げ事由未入力 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 取下げ日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtTorisageYMD();
                    IJiyuNameListDiv 取下げ事由 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getCcdTorisageJiyu();
    ...
    却下日却下事由のチェック_却下日未入力 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 却下日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtKyakkaYMD();
                    IJiyuNameListDiv 却下事由 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getCcdKyakkaJiyu();
    ...
    却下日却下事由のチェック_却下事由未入力 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    TextBoxDate 却下日 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getTxtKyakkaYMD();
                    IJiyuNameListDiv 事由 = div.getCcdZaigaiMeiboSenkyoninJoho().getZaigaiShinseiJoho().getCcdKyakkaJiyu();
    ...
    表示日表示事由のチェック_表示日未入力 {
                @Override
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    if (div.getCcdZaigaiMeiboJoho().isDisplayNone()) {
                        return true;
                    }
                    TextBoxDate 表示日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtHyojiYMD();
                    IJiyuNameListDiv 表示事由 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getCcdHyojiJiyu();
    ...
    表示日表示事由のチェック_表示事由未入力 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    ...
                    TextBoxDate 表示日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtHyojiYMD();
                    IJiyuNameListDiv 事由 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getCcdHyojiJiyu();
    ...
    抹消日抹消事由のチェック_抹消日未入力 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    ...
                    TextBoxDate 抹消日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtMasshoYMD();
                    IJiyuNameListDiv 抹消事由 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getCcdMasshoJiyu();
    ...
    抹消日抹消事由のチェック_抹消事由未入力 {
                ...
                public boolean apply(ZaigaiMeiboTorokuDiv div) {
                    ...
                    TextBoxDate 抹消日 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getTxtMasshoYMD();
                    IJiyuNameListDiv 事由 = div.getCcdZaigaiMeiboJoho().get在外名簿情報().getCcdMasshoJiyu();
