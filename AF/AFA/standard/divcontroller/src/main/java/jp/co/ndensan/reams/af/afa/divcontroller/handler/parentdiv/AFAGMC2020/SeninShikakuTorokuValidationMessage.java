...
/**
 * 洋上投票資格登録のバリデーションメッセージです。
 *
 * @reamsid_L AF-0210-010 liuj2
 */
public enum SeninShikakuTorokuValidationMessage implements IValidationMessage {
    ...
    private SeninShikakuTorokuValidationMessage(IMessageGettable message, String... replace) {
