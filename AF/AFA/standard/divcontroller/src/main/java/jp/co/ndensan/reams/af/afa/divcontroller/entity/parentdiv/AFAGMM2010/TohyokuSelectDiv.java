...
/**
 * TohyokuSelect のクラスファイル 
 * 
 * @author 自動生成
 */
public class TohyokuSelectDiv extends Panel {
    ...
    @JsonProperty("dgTohyokuList")
    private DataGrid<dgTohyokuList_Row> dgTohyokuList;
