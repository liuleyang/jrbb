...
/**
 * KaikuNewJoken のクラスファイル 
 * 
 * @author 自動生成
 */
public class KaikuNewJokenDiv extends Panel {
    ...
    @JsonProperty("chkOnlyPrint")
    private CheckBoxList chkOnlyPrint;
    ...
    /*
     * setchkOnlyPrint
     * @param chkOnlyPrint chkOnlyPrint
     */
    @JsonProperty("chkOnlyPrint")
    public void setChkOnlyPrint(CheckBoxList chkOnlyPrint) {
        this.chkOnlyPrint = chkOnlyPrint;
    }
