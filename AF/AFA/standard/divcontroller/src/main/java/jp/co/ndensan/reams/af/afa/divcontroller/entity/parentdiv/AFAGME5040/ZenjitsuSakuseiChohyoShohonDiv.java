...
/**
 * ZenjitsuSakuseiChohyoShohon のクラスファイル 
 * 
 * @author 自動生成
 */
public class ZenjitsuSakuseiChohyoShohonDiv extends PanelPublish {
     ...
     */
    @JsonProperty("ccdShohonTohyokuCode")
    private TohyokuCodeSelectRangeDiv ccdShohonTohyokuCode;
     ...
     */
    /*
     * getccdShohonTohyokuCode
     * @return ccdShohonTohyokuCode
     */
    @JsonProperty("ccdShohonTohyokuCode")
    public ITohyokuCodeSelectRangeDiv getCcdShohonTohyokuCode() {
        return ccdShohonTohyokuCode;
    }
