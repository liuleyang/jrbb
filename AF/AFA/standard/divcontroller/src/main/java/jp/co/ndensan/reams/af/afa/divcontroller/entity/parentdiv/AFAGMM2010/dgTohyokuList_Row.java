...
/**
 * dgTohyokuList_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgTohyokuList_Row extends DataRow {
    ...
    public dgTohyokuList_Row(RString txtCode, RString txtName, RString txtKanaName, RString txtHyojiJun, RString hidMotoData) {
        super();
        this.setOriginalData("txtCode", txtCode);
        this.setOriginalData("txtName", txtName);
        this.setOriginalData("txtKanaName", txtKanaName);
