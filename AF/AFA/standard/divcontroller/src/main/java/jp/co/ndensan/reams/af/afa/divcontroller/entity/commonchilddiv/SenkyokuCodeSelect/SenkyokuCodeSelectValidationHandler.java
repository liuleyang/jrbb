 ...
 */
public class SenkyokuCodeSelectValidationHandler {
     ...
     */
    public SenkyokuCodeSelectValidationHandler(SenkyokuCodeSelectDiv div) {
        this.div = div;
    }
     ...
     * @return バリデーション突合結果
     */
    public ValidationMessageControlPairs validate選挙区コード() {
        ValidationMessageControlPairs validateResult = new ValidationMessageControlPairs();
        IValidationMessages messages = new SenkyokuCodeSelectErrorValidator(div).validate();
    ...
    private ValidationDictionary createErrorDictionary() {
        return new ValidationDictionaryBuilder().
                add(SenkyokuCodeSelectValidationMessage.選挙区コード, div.getTxtSenkyokuCode()).build();
    }
}
