...
/**
 * ZenjitsuSakuseiChohyoYukenshaList のクラスファイル 
 * 
 * @author 自動生成
 */
public class ZenjitsuSakuseiChohyoYukenshaListDiv extends PanelPublish {
     ...
     */
    @JsonProperty("ccdYukenshaListTohyokuCode")
    private TohyokuCodeSelectRangeDiv ccdYukenshaListTohyokuCode;
     ...
     */
    /*
     * getccdYukenshaListTohyokuCode
     * @return ccdYukenshaListTohyokuCode
     */
    @JsonProperty("ccdYukenshaListTohyokuCode")
    public ITohyokuCodeSelectRangeDiv getCcdYukenshaListTohyokuCode() {
        return ccdYukenshaListTohyokuCode;
    }
