...
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB305.KisaijikoHenkoTsuchiHonninPorperty;
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB305.KisaijikoHenkoTsuchiHonninReport;
 ...
 */
public class KisaijikoHenkoTsuchiHonninPrintService {
    ...
    private static final RString コード種別 = new RString("0033");
     ...
     * 記載事項変更通知（本人）
     *
     * @param kisaijikoHenkoTsuchiHonninList List<KisaijikoHenkoTsuchiHonninParam>
     * @return SourceDataCollection
     */
    public SourceDataCollection print(List<KisaijikoHenkoTsuchiHonninParam> kisaijikoHenkoTsuchiHonninList) {
        try (ReportManager reportManager = new ReportManager()) {
            KisaijikoHenkoTsuchiHonninPorperty property = new KisaijikoHenkoTsuchiHonninPorperty();
            try (ReportAssembler<NotTorokuTsuchiRyojikanReportSource> assembler = ChouhyouCommon.createAssembler(property, reportManager)) {
                ...
                for (KisaijikoHenkoTsuchiHonninParam param : kisaijikoHenkoTsuchiHonninList) {
                    ...
                    List<RString> 本人氏名リスト = notTorokuTsuchiHonnin.get本人氏名１_２(null == 漢字氏名 ? RString.EMPTY : 漢字氏名.getColumnValue(),
                    ...
                    RString 連絡先事務局名 = notTorokuTsuchiHonnin.get事務局名();
                    ...
                    param.setHonninShimei1(本人氏名リスト.get(ZERO));
                    param.setHonninShimei2(本人氏名リスト.get(ONE));
                    ...
                    param.setRenrakusakiIinkaiMei(連絡先事務局名);
                ...
                for (KisaijikoHenkoTsuchiHonninReport report : toReports(kisaijikoHenkoTsuchiHonninList)) {
    ...
    private static List<KisaijikoHenkoTsuchiHonninReport> toReports(List<KisaijikoHenkoTsuchiHonninParam> targets) {
        List<KisaijikoHenkoTsuchiHonninReport> list = new ArrayList<>();
        list.add(new KisaijikoHenkoTsuchiHonninReport(targets));
        return list;
    }
