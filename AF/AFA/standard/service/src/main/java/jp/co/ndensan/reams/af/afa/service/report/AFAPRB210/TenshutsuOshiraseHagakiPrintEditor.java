 ...
 */
public class TenshutsuOshiraseHagakiPrintEditor {
     ...
     * @return TenshutsuOshiraseHagakiParam
     */
    public TenshutsuOshiraseHagakiParam set明細情報1_転出者お知らせハガキ(TenshutsuOshiraseHagakiParam param, Nyujoken3tsuori nyujoken3tsuori) {
        if (null != param.get明細情報1()) {
            ...
            List<RString> 投票所名リスト1 = nyujoken3tsuori.getTohyojoMei(param.get明細情報1().get投票所名(),
            ...
            List<RString> 転出前住所リスト1 = nyujoken3tsuori.getHagakiMeisaiJusho(param.get明細情報1().get住登内住所(),
            ...
            RString バーコード1 = nyujoken3tsuori.getNyujokenBarCode(param.get明細情報1().get抄本番号(), param.get明細情報1().get識別コード());
     ...
     * @return TenshutsuOshiraseHagakiParam
     */
    public TenshutsuOshiraseHagakiParam set明細情報2_転出者お知らせハガキ(TenshutsuOshiraseHagakiParam param, Nyujoken3tsuori nyujoken3tsuori) {
        if (null != param.get明細情報2()) {
            ...
            List<RString> 投票所名リスト2 = nyujoken3tsuori.getTohyojoMei(param.get明細情報2().get投票所名(),
            ...
            List<RString> 転出前住所リスト2 = nyujoken3tsuori.getHagakiMeisaiJusho(param.get明細情報2().get住登内住所(),
            ...
            RString バーコード2 = nyujoken3tsuori.getNyujokenBarCode(param.get明細情報2().get抄本番号(), param.get明細情報2().get識別コード());
     ...
     * @return TenshutsuOshiraseHagakiParam
     */
    public TenshutsuOshiraseHagakiParam set明細情報3_転出者お知らせハガキ(TenshutsuOshiraseHagakiParam param, Nyujoken3tsuori nyujoken3tsuori) {
        if (null != param.get明細情報3()) {
            ...
            List<RString> 投票所名リスト3 = nyujoken3tsuori.getTohyojoMei(param.get明細情報3().get投票所名(),
            ...
            List<RString> 転出前住所リスト3 = nyujoken3tsuori.getHagakiMeisaiJusho(param.get明細情報3().get住登内住所(),
            ...
            RString バーコード3 = nyujoken3tsuori.getNyujokenBarCode(param.get明細情報3().get抄本番号(), param.get明細情報3().get識別コード());
     ...
     * @return TenshutsuOshiraseHagakiParam
     */
    public TenshutsuOshiraseHagakiParam set明細情報4_転出者お知らせハガキ(TenshutsuOshiraseHagakiParam param, Nyujoken3tsuori nyujoken3tsuori) {
        if (null != param.get明細情報4()) {
            ...
            List<RString> 投票所名リスト4 = nyujoken3tsuori.getTohyojoMei(param.get明細情報4().get投票所名(),
            ...
            List<RString> 転出前住所リスト4 = nyujoken3tsuori.getHagakiMeisaiJusho(param.get明細情報4().get住登内住所(),
            ...
            RString バーコード4 = nyujoken3tsuori.getNyujokenBarCode(param.get明細情報4().get抄本番号(), param.get明細情報4().get識別コード());
