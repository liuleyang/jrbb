...
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB303.TorokuTsuchiPorperty;
import jp.co.ndensan.reams.af.afa.business.report.AFAPRB303.TorokuTsuchiReport;
 ...
 */
public class TorokuTsuchiPrintService {
    ...
    private static final RString コード種別 = new RString("0030");
     ...
     * 登録した旨の通知
     *
     * @param notTorokuTsuchiHonninList List<TorokuTsuchiParam>
     * @return SourceDataCollection
     */
    public SourceDataCollection print(List<TorokuTsuchiParam> notTorokuTsuchiHonninList) {
        try (ReportManager reportManager = new ReportManager()) {
            TorokuTsuchiPorperty property = new TorokuTsuchiPorperty();
            try (ReportAssembler<TorokuTsuchiReportSource> assembler = ChouhyouCommon.createAssembler(property, reportManager)) {
                ...
                for (TorokuTsuchiParam param : notTorokuTsuchiHonninList) {
                ...
                for (TorokuTsuchiReport report : toReports(notTorokuTsuchiHonninList)) {
    ...
    private static List<TorokuTsuchiReport> toReports(List<TorokuTsuchiParam> targets) {
        List<TorokuTsuchiReport> list = new ArrayList<>();
        list.add(new TorokuTsuchiReport(targets));
        return list;
    }
